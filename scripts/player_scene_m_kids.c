...
int func_38(int iParam0, Entity eParam1) // Position - 0x4D8C
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_39(Global_101254) && eParam1 != 0)
		{
			Global_101254 = 0;
		}
	}
...
int func_140(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x21736
{
	int i;
	int j;
	int k;
...
BOOL func_141(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x21F47
{
	int num;
...
int func_142(Hash hParam0) // Position - 0x21FE8
{
	switch (hParam0)
	{
		case 225514697:
...
void func_143(Hash hParam0, int iParam1, int iParam2) // Position - 0x22023
{
	int num;
	int num2;
...
BOOL func_144(Hash hParam0, int iParam1, int iParam2) // Position - 0x220AD
{
	if (hParam0 == 225514697)
		if (iParam1 == 4)
...
BOOL func_145(Hash hParam0, int iParam1, int iParam2) // Position - 0x2218B
{
	Global_79172[1 /*14*/] = { func_70(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79172[1 /*14*/].f_6, 2);
}

BOOL func_146(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x221B3
{
	int num;
...
int func_147(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2225E
{
	int i;
	int j;
...
int func_148(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x222FF
{
	int num;
...
int func_149(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22606
{
	int num;
	int num2;
	int num3;
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							if (num6 >= 5 && num6 <= 8 || num6 >= 25 && num6 <= 40 || num6 >= 42 && num6 <= 43)
								if (!func_150(-1692214353, num4, num6, num5, &num7))
									if (num7 != -99)
										num = num7;
...
int func_151(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2349D
{
	int num;
...
int func_152(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x23764
{
	int i;
	int num;
...
BOOL func_154(Hash hParam0, int iParam1, var uParam2) // Position - 0x237C4
{
	*uParam2 = -99;
...
int func_155(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x23A8E
{
	int num;
...
int func_156(Hash hParam0, int iParam1, int iParam2) // Position - 0x23D18
{
	switch (hParam0)
	{
		case 225514697:
...
void func_157(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x23E6F
{
	int num;
...
BOOL func_158(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x23F09
{
	switch (hParam0)
	{
		case 1885233650:
...
int func_159(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x23FD7
{
	Hash entityModel;
...
int func_162(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x24298
{
	int pedPropIndex;
...
void func_164(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x2438B
{
	int num;
	int offset;
	int num2;
...
int func_174(var uParam0, eCharacter echParam1) // Position - 0x25F58
{
	int num;
