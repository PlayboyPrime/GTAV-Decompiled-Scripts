...
int func_38(int iParam0, Entity eParam1) // Position - 0x4D8C (19852)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_39(Global_101614) && eParam1 != 0)
		{
			Global_101614 = 0;
		}
	}
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_49(pedParam0, i, unk[i]))
				{
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_70(entityModel, i, num, -1) };
					
						if (!func_53(entityModel, iParam2, i, num, &unk, &Global_79527[2 /*14*/]))
							return false;
					}
				}
			}
