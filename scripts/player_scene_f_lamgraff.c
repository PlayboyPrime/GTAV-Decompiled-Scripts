...
void func_37() // Position - 0xFB7
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_101409))
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_101409, 1862763509);
	}
	...
	switch (uParam0.f_2)
	{
		...
		case 80:
			*uParam109 = { uParam0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_44(uParam109, 17, -2017877118, -2017877118, { 2.6407f, 8.164f, -14.1564f } + { -1f, 0.03f, -2.16f }, -66f + -56f);
