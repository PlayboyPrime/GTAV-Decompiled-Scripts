...
BOOL func_39(Ped pedParam0, int iParam1, int iParam2) // Position - 0x184E
{
	...
	Global_79172[1 /*14*/] = { func_92(entityModel, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_92(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_84(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
{
	Global_79172[1 /*14*/] = { func_92(hParam0, iParam1, iParam2, -1) };
...
ePedComponentType func_84(int iParam0) // Position - 0x98E1
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_85(Hash hParam0, int iParam1) // Position - 0x9991
{
	int i;
	var unk;
...
struct<17> func_88(Hash hParam0, int iParam1) // Position - 0xA432
{
	int i;
	var unk;
...
struct<14> func_92(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC586
{
	func_156();
...
void func_102(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE9B1
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_95(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_95(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_157(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1FD97
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_157(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_157(pedParam0, 14, k))
											if (!func_46(entityModel, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_92(entityModel, i, num, -1) };
					
						if (!func_46(entityModel, iParam2, i, num, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_84(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_84(iParam1)))
	{
		return true;
	}
			...
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (func_265(1, 20f, 1))
				{
					if (!bLocal_381 || MISC::GET_GAME_TIMER() > iLocal_382 + 3000 || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						if (func_323(pedLocal_153))
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_153, "Dom", 0, 1198698306, 0);
...
void func_287() // Position - 0x2A346
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(veLocal_171))
		veLocal_171 = VEHICLE::CREATE_VEHICLE(788045382, 1662.8799f, -14.255f, 172.7742f, 205.3516f, true, true, false);

	if (!ENTITY::DOES_ENTITY_EXIST(veLocal_172))
		veLocal_172 = VEHICLE::CREATE_VEHICLE(1131912276, 1633.7656f, -23.6768f, 127.0535f, 55.7565f, true, true, false);

	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_174))
	{
		obLocal_174 = OBJECT::CREATE_OBJECT(1165008631, 1666.2823f, -11.204082f, 172.7773f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(obLocal_174, 0.000637f, -0.000136f, 10.660593f, 2, true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_175))
	{
		obLocal_175 = OBJECT::CREATE_OBJECT(1165008631, 1667.0764f, -12.07778f, 173.2611f, true, true, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_177))
		obLocal_177 = OBJECT::CREATE_AMBIENT_PICKUP(1735599485, 1665.264f, -11.4427f, 172.7747f, 7, -1, 1269906701, true, true);
		...
		case 0:
			...
			if (func_299(1, 1093140480, 0))
			{
				if (!bLocal_381 || MISC::GET_GAME_TIMER() > iLocal_382 + &func_19)
				{
					...
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_80.f_28[0]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_80.f_28[0], "Hudson", 0, 882848737, 0);
...
void func_324() // Position - 0x2B9F4
{
	...
	{
		obLocal_173 = OBJECT::CREATE_OBJECT_NO_OFFSET(798951501, 1658.299f, -7.930665f, 173.71f, true, true, false, 0);
...
int func_327(var uParam0, eCharacter echParam1) // Position - 0x2BCBC
{
	int num;
...
void func_328(int iParam0) // Position - 0x2BD02
{
	...
	if (iParam0 == 1)
	{
		while (!STREAMING::HAS_MODEL_LOADED(pedLocal_153.f_5) || !STREAMING::HAS_MODEL_LOADED(788045382) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmextreme4") || !STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@") || !STREAMING::HAS_PTFX_ASSET_LOADED())
		{
			SYSTEM::WAIT(0);
		}
	}
