									...
									case 2:
										...
										if (SYSTEM::TIMERB() > 500)
										{
											if (ENTITY::DOES_ENTITY_EXIST(obLocal_165))
											{
												...
												{
													func_151();
													WEAPON::SET_CURRENT_PED_WEAPON(iLocal_112[0], -1569615261, true);
												...
												for (l = 0; l <= iLocal_109 - 1; l = l + 1)
												{
													if (!uLocal_139[l])
													{
														if (!PED::IS_PED_INJURED(iLocal_112[l]))
														{
															...
															{
																TASK::TASK_DRIVE_BY(iLocal_112[l], PLAYER::PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, false, -753768974);
																uLocal_139[l] = 1;
															}
...
void func_1() // Position - 0x122B
{
	...
	if (bLocal_179)
	{
		if (!bLocal_181)
		{
			...
			obLocal_165 = OBJECT::CREATE_OBJECT(1666748342, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true, true, false);
...
BOOL func_80(int iParam0) // Position - 0x4D56
{
	Hash entityModel;
...
void func_106() // Position - 0x895B
{
	...
	if (!OBJECT::DOES_PICKUP_EXIST(pkLocal_108))
	{
		...
		pkLocal_108 = OBJECT::CREATE_PICKUP(341217064, uLocal_105, iLocal_104, iLocal_187, true, 1666748342);
...
void func_151() // Position - 0x9E46
{
	...
	OBJECT::DELETE_OBJECT(&obLocal_165);
	obLocal_165 = OBJECT::CREATE_OBJECT(1666748342, entityCoords, true, true, false);
			...
			if (iLocal_47 == 1)
			{
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_173, false))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_112[1]))
						{
							PED::FORCE_PED_MOTION_STATE(iLocal_112[1], -530524, true, 0, false);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_150);
							TASK::TASK_CLEAR_LOOK_AT(0);
...
void func_159() // Position - 0xAB17
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(model))
	{
		...
		pedLocal_182 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_173, PED_TYPE_MISSION, 611648169, -1, true, true);
		...
		WEAPON::GIVE_WEAPON_TO_PED(pedLocal_182, 453432689, -1, true, true);
...
void func_178() // Position - 0xB986
{
	...
	for (i = 0; i <= iLocal_109 - 1; i = i + 1)
	{
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_112[i], 453432689, -1, true, true);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_188, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, hLocal_188);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_188, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, hLocal_188);
	...
	if (iLocal_47 == 1)
	{
		...
		uLocal_166[0] = OBJECT::CREATE_OBJECT(-1170050911, uLocal_95, true, true, false);
		uLocal_166[1] = OBJECT::CREATE_OBJECT(-1170050911, uLocal_95 - { 0.1f, 0f, 0f }, true, true, false);
...
void func_186() // Position - 0xCAFC
{
	...
	if (iLocal_47 == 1)
	{
		hLocal_217 = 1546450936;
		hLocal_218 = 1720428295;
		hLocal_219 = 1546450936;
		hLocal_220 = 611648169;
		iLocal_109 = 2;
		iLocal_110 = 3;
		iLocal_111 = 3;
		...
		hLocal_186 = 1666748342;
		iLocal_187 = 2000;
		uLocal_192 = { -822.8538f, -187.7645f, 36.5792f };
	}
	else if (iLocal_47 == 2)
	{
		hLocal_216 = 587703123;
		hLocal_217 = 429425116;
		hLocal_218 = 587703123;
		hLocal_219 = 429425116;
		hLocal_220 = 228715206;
		iLocal_109 = 2;
		iLocal_110 = 2;
		iLocal_111 = 2;
