...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0xB32A (45866)
{
	int num;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0xC636 (50742)
{
	int i;
