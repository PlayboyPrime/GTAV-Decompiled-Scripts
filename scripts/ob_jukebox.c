...
void func_67(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x2FC8 (12232)
{
	...
	if (bParam3)
	{
		...
		{
			func_103(Global_24131.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
...
void func_74(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x625D (25181)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_103(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x7695 (30357)
{
	int num;
	float num2;
	float num3;
...
int func_112() // Position - 0x7C9C (31900)
{
...
void func_220(int iParam0, BOOL bParam1) // Position - 0xBD2B (48427)
{
	if (func_5(iParam0) == 97)
	{
...
void func_224(int iParam0, int iParam1) // Position - 0xBEB2 (48818)
{
	char* radioStation;
...
int func_243() // Position - 0xC857 (51287)
{
	int unk;
