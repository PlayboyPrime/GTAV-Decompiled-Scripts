			...
			if (func_39(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_1))
			{
				if (func_21(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_2, 1086324736, 1065353216, 1065353216, 1084227584, true, true, true, 1123024896, false, -1, true, 0, false, 0, false, false))
				{
					if (func_20(&iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/], PED_TYPE_CRIMINAL, iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_1, iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_2, iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_5, true, true, true))
					{
						...
						WEAPON::GIVE_DELAYED_WEAPON_TO_PED(NETWORK::NET_TO_PED(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/]), 453432689, 25000, false);
	...
	if (STREAMING::HAS_MODEL_LOADED(iLocal_90.f_2.f_1[iParam0 /*66*/].f_3))
	{
		...
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_90.f_2.f_1[iParam0 /*66*/].f_1))
		{
			...
			if (NETWORK::CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
			{
				...
				iLocal_90.f_2.f_1[iParam0 /*66*/].f_1 = NETWORK::OBJ_TO_NET(OBJECT::CREATE_PORTABLE_PICKUP(1852930709, func_57(iParam0), false, iLocal_90.f_2.f_1[iParam0 /*66*/].f_3));
		...
		case 0:
			...
			switch (uParam0->f_30)
			{
				...
				case 8:
					...
					if (func_66(1885233650, Global_262145.f_67, &(uParam0->f_34), &(uParam0->f_35)))
						if (func_65(PLAYER::PLAYER_ID()))
							uLocal_461[0] = Global_262145.f_67;
				
					if (func_66(-1667301416, Global_262145.f_68, &(uParam0->f_36), &(uParam0->f_37)))
						if (!func_65(PLAYER::PLAYER_ID()))
							uLocal_461[0] = Global_262145.f_68;
				
					for (i = 0; i < 4; i = i + 1)
					{
						if (func_66(1885233650, func_64(i, true), &uParam0->f_38[i], &uParam0->f_43[i]))
							if (func_65(PLAYER::PLAYER_ID()))
								uLocal_461[i + 1] = func_64(i, true);
					
						if (func_66(-1667301416, func_64(i, false), &uParam0->f_48[i], &uParam0->f_53[i]))
							if (!func_65(PLAYER::PLAYER_ID()))
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]))
	{
		if (!IS_BIT_SET(uLocal_449[iParam0], 0 + iParam1))
		{
			if (ENTITY::IS_ENTITY_DEAD(NETWORK::NET_TO_PED(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), false))
			{
				...
				{
					func_127(0, NETWORK::NET_TO_PED(iLocal_90.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), "XPT_KAIE" /*~g~+~1~ ~a~:~s~ Killed Hostile*/, -1859646258, 2131309714, SYSTEM::ROUND(50f * Global_262145.f_3926), 1, -1, 0, false, 0);
...
void func_208(int iParam0) // Position - 0xA7CC
{
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_90.f_2.f_1[iParam0 /*66*/].f_1))
		func_127(0, NETWORK::NET_TO_OBJ(iLocal_90.f_2.f_1[iParam0 /*66*/].f_1), "XPT_MEDIUMT", -979004785, 1022861207, num, 1, -1, 0, false, 0);
	else
		func_127(0, PLAYER::PLAYER_PED_ID(), "XPT_MEDIUMT", -979004785, 1022861207, num, 1, -1, 0, false, 0);
	...
	switch (iLocal_90.f_2.f_1[iParam0 /*66*/].f_30)
	{
		...
		case 8:
			...
			{
				if (iLocal_90.f_2.f_1[iParam0 /*66*/].f_33 != 1119849093)
...
void func_248(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x19CE9
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_238(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_238(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
