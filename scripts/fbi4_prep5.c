		...
		case 0:
			if (func_97(iLocal_82, false))
			{
				if (_IS_MISSION_REPLAY_IN_PROGRESS())
				{
					...
					func_118(&unk4, unk, num, 0, 0, 0, 0, 0, -1903012613, 0, _CHAR_NULL, 1);
					func_115(0, -1, 1);
...
BOOL func_125(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x6F78
{
	...
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_126(veParam0) && ENTITY::GET_ENTITY_MODEL(veParam0) != 873639469 && ENTITY::GET_ENTITY_MODEL(veParam0) != -1177863319)
		{
			*uParam2 = 2;
			return false;
		}
...
BOOL func_155(Vehicle veParam0) // Position - 0x856C
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_159(PLAYER::PLAYER_ID(), true, false) && Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_35 > 0 || IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 14) || IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 11))
			return false;
...
BOOL func_174(Hash hParam0) // Position - 0x939A
{
	if (hParam0 == 0)
		return false;
...
BOOL func_175(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x9558
{
	int i;
	Hash outData;
...
void func_221(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC82A
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_223() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, -2118308144) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_136(true)))
...
BOOL func_224(int iParam0) // Position - 0xD02F
{
	int num;
...
BOOL func_225(int iParam0) // Position - 0xD053
{
	int num;
...
BOOL func_241(var uParam0) // Position - 0xD3D4
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_99(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;
...
{
	func_308(225514697, 12, 20, bParam0);
	func_308(225514697, 12, 21, bParam0);
	func_308(225514697, 12, 22, bParam0);
	func_308(-1692214353, 12, 13, bParam0);
	func_308(-1692214353, 12, 14, bParam0);
	func_308(-1692214353, 12, 15, bParam0);
	func_308(-1686040670, 12, 17, bParam0);
	func_308(-1686040670, 12, 18, bParam0);
	func_308(-1686040670, 12, 19, bParam0);
	return;
}
...
void func_320(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x154E9
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_313(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_313(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
