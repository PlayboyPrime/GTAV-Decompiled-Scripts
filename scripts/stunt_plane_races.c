...
BOOL func_1() // Position - 0x1D1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_49.f_1))
		...
		iLocal_49.f_1 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 10f, -2122757008, 0);
	...
	switch (iLocal_2320.f_6)
	{
		...
		case 3:
			...
			else if (CAM::DOES_CAM_EXIST(caLocal_2045) && CAM::IS_CAM_ACTIVE(caLocal_2045) && CAM::IS_SCREEN_FADED_IN())
			{
				...
				bLocal_2411.f_2858 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, fLocal_43, uLocal_46, 34.9705f, true, 2);
		...
		case 8:
			...
			if (iLocal_49.f_10 == 0)
			{
				...
				func_373();
				caLocal_2045 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1702.4866f, 3279.5454f, 41.9968f, -2.9399f, 0f, 110.4428f, 45.0218f, true, 2);
...
void func_42(var uParam0) // Position - 0x2619
{
	...
	num3 = SYSTEM::FLOOR(Global_113969.f_19046.f_6[iLocal_49.f_10] * 100f) * 10;
...
void func_44(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x2A1C
{
	int num;
	int i;
...
void func_47(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x2BA8
{
	int num;
	int i;
...
void func_48(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15) // Position - 0x2CB8
{
	int num;
	int i;
...
void func_111(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6303
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_114() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, -2118308144) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_113(true)))
...
BOOL func_115(int iParam0) // Position - 0x6B22
{
	int num;
...
BOOL func_116(int iParam0) // Position - 0x6B46
{
	int num;
...
BOOL func_117(int iParam0, int iParam1) // Position - 0x6B64
{
...
int func_124(Vehicle veParam0, int iParam1) // Position - 0x6FA9
{
	int i;
...
int func_141(Player plParam0) // Position - 0x7787
{
	if (func_140(plParam0))
		if (func_139(plParam0, false))
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x7800
{
	Player player;
...
void func_196(int iParam0) // Position - 0x9133
{
	if (iParam0 >= 4)
	{
		...
		{
			uLocal_2058[0] = VEHICLE::CREATE_VEHICLE(1518533038, -449.6041f, -2271.6929f, 6.6086f, 267.5199f, true, true, false);
			uLocal_2058[1] = VEHICLE::CREATE_VEHICLE(-730904777, -449.6041f, -2271.6929f, 6.6086f, 267.5199f, true, true, false);
			VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_2058[0], uLocal_2058[1], 1065353216);
			uLocal_2064[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_2058[0], PED_TYPE_CIVMALE, 349680864, -1, true, true);
	...
	if (iParam0 >= 1)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2058[0]))
		{
			if (!func_376(iLocal_2070, 1))
			{
				...
				{
					uLocal_2058[0] = VEHICLE::CREATE_VEHICLE(788045382, -2586.9011f, 386.4225f, 208.0505f, 349.0836f, true, true, false);
					func_348(&iLocal_2070, 1);
				}
			}
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_2058[0]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2064[0]))
			{
				...
				{
					uLocal_2064[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_2058[0], PED_TYPE_CIVMALE, 1694362237, -1, true, true);
	...
	if (iParam0 >= 1)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2058[1]))
		{
			if (!func_376(iLocal_2071, 1))
			{
				if (func_199(&iLocal_2052))
				{
					uLocal_2058[1] = VEHICLE::CREATE_VEHICLE(788045382, -2582.9304f, 384.918f, 208.5764f, 336.8248f, true, true, false);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_2058[1]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2064[1]))
			{
				...
				{
					uLocal_2064[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_2058[1], PED_TYPE_CIVMALE, 1694362237, -1, true, true);
...
void func_201(int iParam0) // Position - 0x95B5
{
	if (iParam0 == 6)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2058[0]) && !func_376(iLocal_2070, 1))
		{
			uLocal_2058[0] = VEHICLE::CREATE_VEHICLE(861409633, -1429.1023f, 2602.645f, -1.0709f, 85.2614f, true, true, false);
			uLocal_2064[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_2058[0], PED_TYPE_CIVMALE, 349680864, -1, true, true);
	...
	if (!func_376(iLocal_2070, 1))
	{
		if (iParam0 < 3)
		{
			if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(101, "SPRStuntAF"))
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2058[0]))
				{
					uLocal_2058[0] = VEHICLE::CREATE_VEHICLE(1058115860, -943.8105f, -3173.6924f, 12.9445f, 60.537f, true, true, false);
					...
					uLocal_2064[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_2058[0], PED_TYPE_CIVMALE, -245247470, -1, true, true);
				}
				...
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_2058[0], false))
					if (ENTITY::IS_ENTITY_AT_COORD(uLocal_2058[0], -943.8105f, -3173.6924f, 12.9445f, 20f, 20f, 20f, false, true, 0))
						...
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_2064[0], false))
							if (!(TASK::GET_SCRIPT_TASK_STATUS(uLocal_2064[0], SCRIPT_TASK_VEHICLE_DRIVE_TO_COORD) == 1))
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_2064[0], uLocal_2058[0], -6793.876f, -557.0385f, 781.0172f, 50f, 0, 1058115860, 262144, -1f, -1f);
			}
		}
...
void func_206() // Position - 0x99F7
{
	...
	{
		case 3:
			func_208(&iLocal_2052, 1058115860);
			func_208(&iLocal_2052, -245247470);
			VEHICLE::REQUEST_VEHICLE_RECORDING(101, "SPRStuntAF");
			break;
	
		case 0:
			func_208(&iLocal_2052, 861409633);
			func_208(&iLocal_2052, 349680864);
			break;
	
		case 1:
			func_208(&iLocal_2052, 788045382);
			func_208(&iLocal_2052, 1694362237);
			break;
	
		case 2:
			func_208(&iLocal_2052, 1518533038);
			func_208(&iLocal_2052, -730904777);
			func_208(&iLocal_2052, 349680864);
...
BOOL func_227(Player plParam0) // Position - 0xA6F6
{
	...
	switch (iLocal_1988)
	{
		...
		case 1:
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				caLocal_2046 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, fLocal_2254, uLocal_2257, fLocal_2260, true, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
		...
		case 5:
			...
			caLocal_2045 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, fLocal_2254, fLocal_2254.f_1, fLocal_2254.f_2 + 1000f, 90f, uLocal_2257.f_1, uLocal_2257.f_2, fLocal_2260, false, 2);
...
void func_323() // Position - 0xD0A1
{
	...
	num = Global_112999;
	func_324(unk, 0, 0, 0, 0, num);
	return;
}

void func_324(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0xD0BD
{
	float num;
	int value;
	int alpha;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_327(Global_79645, Global_79647, iParam10) };
				y == -0.014f;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0xEDD4
{
	uParam0->f_1 = 0;
	return;
}
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x12666
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x127A1
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x127FF
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x18C7E
{
	return uParam0->f_1;
}
...
void func_506(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, Hash hParam44, BOOL bParam45, BOOL bParam46) // Position - 0x1A4A9
{
	...
	switch (uParam0.f_29[iParam43])
	{
		...
		case 8:
			if (func_514(hParam44) != 0)
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_511(func_514(hParam44), false));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
		...
		case 21:
			...
			{
				componentType = { func_510(hParam44) };
		...
		case 22:
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER" /*~1~*/);
				HUD::ADD_TEXT_COMPONENT_INTEGER(func_507(hParam44));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
...
int func_507(Hash hParam0) // Position - 0x1A8B1
{
	Hash value;
	float num;
	int num2;
...
struct<4> func_510(Hash hParam0) // Position - 0x1A9DC
{
	var unk;
...
int func_514(Hash hParam0) // Position - 0x1B9BE
{
	if (hParam0 == 600)
		return 1834241177;
	else if (hParam0 == 500)
...
void func_569(var uParam0) // Position - 0x204DD
{
	...
	func_570(&uParam0->f_358[0 /*189*/], 0, -1692214353, -2122757008);
	return;
}
...
void func_597(Any* panParam0) // Position - 0x22081
{
	int i;
...
void func_607(var uParam0, int iParam1) // Position - 0x22474
{
	...
	iLocal_49.f_7 = 4;
	iLocal_49.f_8 = -1736970383;
	iLocal_49.f_9 = -2122757008;
