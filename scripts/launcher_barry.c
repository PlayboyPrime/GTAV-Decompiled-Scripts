...
BOOL func_86(Player plParam0) // Position - 0x7690
{
...
BOOL func_94(Player plParam0) // Position - 0x8547
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE0E9
{
	...
	if (func_263(*panParam0) || func_261(*panParam0) || Global_79635 == 1)
		return true;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[1]))
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					...
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_28[0], 453432689, 100, true);
				}
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]))
				{
					...
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_28[1], 453432689, 100, true);
				}
			}
...
int func_285(var uParam0, eCharacter echParam1) // Position - 0x10889
{
	int num;
