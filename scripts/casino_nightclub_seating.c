...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x193F (6463)
{
	int num;
...
int func_81(int iParam0) // Position - 0x2168 (8552)
{
	switch (iParam0)
	{
		case 0:
...
void func_82() // Position - 0x2684 (9860)
{
	Global_1943900 = 0;
	func_84(&uLocal_134);
	func_83();
...
void func_83() // Position - 0x269B (9883)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_84(var uParam0) // Position - 0x26A7 (9895)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2706 (9990)
{
...
BOOL func_86(int iParam0) // Position - 0x2BBA (11194)
{
	return iParam0 == 17;
}

void func_87() // Position - 0x2BC7 (11207)
{
	var unk;
...
void func_88() // Position - 0x2C14 (11284)
{
...
BOOL func_89(Ped pedParam0) // Position - 0x2C52 (11346)
{
	int scriptTaskStatus;
...
void func_90(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C83 (11395)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D53 (11603)
{
	Hash statName;
...
void func_92() // Position - 0x2D6F (11631)
{
	eViewModeContext i;
...
BOOL func_93(Player plParam0) // Position - 0x2DC7 (11719)
{
...
BOOL func_94() // Position - 0x2E06 (11782)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_95(Player plParam0, int iParam1) // Position - 0x2E14 (11796)
{
	BOOL flag;
...
int func_96(int iParam0, BOOL bParam1) // Position - 0x2E6D (11885)
{
	int num;
	int num2;
...
int func_97() // Position - 0x2EAE (11950)
{
	return Global_1574926;
}

BOOL func_98(Player plParam0) // Position - 0x2EBA (11962)
{
	Player player;
...
BOOL func_99() // Position - 0x2EDC (11996)
{
...
void func_100() // Position - 0x2F0D (12045)
{
...
void func_101() // Position - 0x2F3B (12091)
{
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2FB7 (12215)
{
	var unk;
	float num;
...
Vector3 func_103() // Position - 0x3048 (12360)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x305B (12379)
{
	float num;
	float num2;
	float num3;
...
float func_105(int iParam0, float fParam1) // Position - 0x309F (12447)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106() // Position - 0x30D8 (12504)
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2) // Position - 0x30EB (12523)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108() // Position - 0x343B (13371)
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x3443 (13379)
{
	int i;
...
BOOL func_110(BOOL bParam0) // Position - 0x3559 (13657)
{
	bParam0;
