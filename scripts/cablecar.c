...
int func_117(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x49C5
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_165(entityModel, iParam1, iParam2, -1) };
...
{
	Global_79172[1 /*14*/] = { func_165(hParam0, iParam1, iParam2, -1) };
...
struct<14> func_165(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF499
{
	func_228();
...
void func_174(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x11902
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_168(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_168(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_229(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_229(pedParam0, 14, k))
											if (!func_123(entityModel, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_165(entityModel, i, num, -1) };
					
						if (!func_123(entityModel, iParam2, i, num, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
