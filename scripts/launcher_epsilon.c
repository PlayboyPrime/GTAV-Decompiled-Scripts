...
{
	Global_64327 = 0;
	Global_64331 = func_15(-669750575);
	Global_64330 = func_15(-2097237603);
	Global_64333 = func_15(-1901131717);
	Global_64332 = func_15(2020326774);
	Global_64335 = func_15(-1675981664);
	Global_64334 = func_15(165162477);
	return;
}
...
int func_217(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xDB18
{
	int i;
	int j;
	int k;
...
BOOL func_219(Ped pedParam0, int iParam1, int iParam2) // Position - 0xE3CA
{
	Hash entityModel;
	int num;
	int i;
...
void func_221(Hash hParam0, int iParam1, int iParam2) // Position - 0xE65E
{
	int num;
	int num2;
...
BOOL func_222(Hash hParam0, int iParam1, int iParam2) // Position - 0xE6E8
{
	if (hParam0 == 225514697)
		if (iParam1 == 4)
...
BOOL func_223(Hash hParam0, int iParam1, int iParam2) // Position - 0xE7C6
{
	Global_79322[1 /*14*/] = { func_266(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_224(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xE7EE
{
	var unk;
	int i;
...
BOOL func_225(Hash hParam0, int iParam1, int iParam2) // Position - 0xEDF2
{
	switch (hParam0)
	{
		case 225514697:
...
int func_227(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xEF36
{
	int i;
	int j;
...
int func_229(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF087
{
	int num;
...
int func_230(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF38E
{
	int num;
	int num2;
	int num3;
...
int func_232(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10226
{
	int num;
...
int func_233(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x104ED
{
	int i;
	int num;
...
BOOL func_234(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10524
{
	int num;
...
BOOL func_235(Hash hParam0, int iParam1, var uParam2) // Position - 0x1054D
{
	*uParam2 = -99;
...
int func_236(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x10817
{
	int num;
...
int func_237(Hash hParam0, int iParam1, int iParam2) // Position - 0x10AA1
{
	switch (hParam0)
	{
		case 225514697:
...
void func_238(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x10BF8
{
	int num;
...
BOOL func_239(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10C92
{
	switch (hParam0)
	{
		case 1885233650:
...
Hash func_240(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10D60
{
	var outProp;
	int componentId;
	int num;
...
int func_243(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x11282
{
	Hash entityModel;
...
struct<10> func_248(Hash hParam0, int iParam1) // Position - 0x1165C
{
	int i;
	var unk;
...
struct<17> func_251(Hash hParam0, int iParam1) // Position - 0x120FD
{
	int i;
	var unk;
...
BOOL func_255(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14251
{
	switch (hParam0)
	{
		case 225514697:
...
BOOL func_256(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x144CE
{
	if (hParam0 == 225514697)
	{
		if (iParam1 == 6)
...
BOOL func_257(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x148F3
{
	switch (hParam0)
	{
		case 225514697:
...
int func_258(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14BE6
{
	int pedPropIndex;
...
int func_259(Ped pedParam0, int iParam1) // Position - 0x14C2D
{
...
void func_262(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x14D90
{
	int num;
	int offset;
	int num2;
...
BOOL func_263(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x14DD8
{
...
struct<14> func_266(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x188E7
{
	func_329();
...
BOOL func_273(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1AC3D
{
	int num;
	int num2;
	int num3;
...
void func_275(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1AD4F
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_269(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_269(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
int func_330(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x2C237
{
	int num;
	int i;
	int j;
...
int func_331(Hash hParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2C619
{
	Global_79322[1 /*14*/] = { func_266(hParam0, iParam1, iParam2, -1) };
...
void func_411(int iParam0, var uParam1) // Position - 0x2FD5E
{
	...
	switch (iParam0)
	{
		...
		case 142:
			if (func_412(iParam0))
			{
				if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(1139079984) == 0 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(478649282) == 0 && !Global_114135.f_9089.f_99.f_58[4])
				{
					if (num2 < 21)
					{
						if (num2 >= 7)
