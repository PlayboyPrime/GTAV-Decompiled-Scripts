...
int func_136(var uParam0) // Position - 0x305B
{
	return *uParam0;
}
...
int func_147(int* piParam0) // Position - 0x326C
{
	if (!func_14(&(piParam0->f_6.f_7), 2))
		return 0;
...
int func_148(int* piParam0) // Position - 0x328D
{
...
char* func_178(char* sParam0) // Position - 0x4394
{
	return sParam0;
}
