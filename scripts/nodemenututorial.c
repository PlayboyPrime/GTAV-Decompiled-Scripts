...
int func_136(var uParam0) // Position - 0x3049
{
	return *uParam0;
}
...
int func_147(int* piParam0) // Position - 0x325A
{
	if (!func_14(&(piParam0->f_6.f_7), 2))
		return 0;
...
int func_148(int* piParam0) // Position - 0x327B
{
...
void func_194(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x4AFA
{
	...
	if (bParam3)
	{
		...
		{
			func_171(Global_23831.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
								...
								if (flag2)
								{
									if (!Global_23831.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23831.f_79[num16 /*6*/]) != 0)
										{
											...
											func_182(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, num36, flag5, flag4);
