...
int func_117(int iParam0, BOOL bParam1) // Position - 0x597B (22907)
{
	int num;
	int num2;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x7103 (28931)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9F7A (40826)
{
