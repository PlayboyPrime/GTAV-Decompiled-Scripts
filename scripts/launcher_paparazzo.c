...
BOOL func_86(Player plParam0) // Position - 0x75FD
{
...
BOOL func_94(Player plParam0) // Position - 0x84B5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD95C
{
	...
	if (func_250(*panParam0) || func_248(*panParam0) || Global_79635 == 1)
		return true;
...
int func_261(var uParam0, eCharacter echParam1) // Position - 0xFBFB
{
	int num;
