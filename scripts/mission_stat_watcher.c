					...
					if (Global_64311)
					{
						...
						for (j = 0; j < Global_97893[Global_64312 /*38*/].f_37; j = j + 1)
						{
							if (Global_97893[Global_64312 /*38*/].f_31[j] > 0)
								func_96(&uLocal_43, 3, func_95(Global_97893[Global_64312 /*38*/].f_25[j]), "", -1 * Global_97893[Global_64312 /*38*/].f_31[j], 0, 0, 0);
						}
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBF5B (48987)
{
	...
	if (num3 == 14)
		Global_76404[iParam1 /*9*/].f_1 = BUILTIN::FLOOR(Global_76404[iParam1 /*9*/].f_2);
	...
	if (!(num3.f_2 == 0))
	{
		num2 = BUILTIN::TO_FLOAT(BUILTIN::FLOOR((BUILTIN::TO_FLOAT(Global_76404[iParam1 /*9*/].f_1) / BUILTIN::TO_FLOAT(num3.f_2)) * 100f));
	...
	str = func_89(Global_76404[iParam1 /*9*/]);
	...
	else
	{
		...
		switch (num3)
		{
			...
			case 5:
				func_96(uParam0, 11, str, "", BUILTIN::CEIL((BUILTIN::TO_FLOAT(Global_76404[iParam1 /*9*/].f_1) / BUILTIN::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 9:
				func_96(uParam0, 11, str, "", BUILTIN::ROUND(Global_76404[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D (54797)
{
	...
	if (func_101(false) && Global_64300)
	{
...
void func_98(int iParam0) // Position - 0xD824 (55332)
{
	...
	if (iParam0 == 2)
	{
		num4 = BUILTIN::FLOOR(BUILTIN::TO_FLOAT(Global_114135.f_1.f_126[iParam0 /*23*/].f_1) * 0.78f);
	...
	for (i = 0; i < 5; i = i + 1)
	{
		...
		switch (Global_114135.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			...
			case 2:
			case 0:
				Global_114135.f_1.f_126[iParam0 /*23*/].f_17[i] = BUILTIN::CEIL(BUILTIN::TO_FLOAT(Global_97538[num5 /*5*/].f_1) * 0.01f * (float)Global_114135.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_114135.f_1.f_126[iParam0 /*23*/].f_17[i] = BUILTIN::CEIL(BUILTIN::TO_FLOAT(Global_97538[num5 /*5*/].f_1) * 0.015f * (float)Global_114135.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_114135.f_1.f_126[0 /*23*/].f_2[1] = BUILTIN::CEIL(0.12f * (float)Global_114135.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_114135.f_1.f_126[0 /*23*/].f_2[1];
			Global_97883.f_7 = BUILTIN::CEIL(0.14f * (float)Global_114135.f_1.f_126[iParam0 /*23*/].f_1);
		...
		case 2:
			...
			Global_97883.f_7 = BUILTIN::CEIL(0.12f * (float)Global_114135.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_97883.f_7;
	...
	if (Global_114135.f_1.f_126[iParam0 /*23*/].f_6[0] != -1f)
		Global_114135.f_1.f_126[iParam0 /*23*/].f_6[0] = (BUILTIN::TO_FLOAT(Global_114135.f_1.f_126[iParam0 /*23*/].f_2[0]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_114135.f_1.f_126[iParam0 /*23*/].f_6[1] != -1f)
		Global_114135.f_1.f_126[iParam0 /*23*/].f_6[1] = (BUILTIN::TO_FLOAT(Global_114135.f_1.f_126[iParam0 /*23*/].f_2[1]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_114135.f_1.f_126[iParam0 /*23*/].f_6[2] != -1f)
		Global_114135.f_1.f_126[iParam0 /*23*/].f_6[2] = (BUILTIN::TO_FLOAT(Global_114135.f_1.f_126[iParam0 /*23*/].f_2[2]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_97883.f_6 != -1f)
		Global_97883.f_6 = (BUILTIN::TO_FLOAT(Global_97883.f_7) / BUILTIN::TO_FLOAT(value)) * 100f;
	...
	for (i = 0; i < Global_76403; i = i + 1)
	{
		if (Global_76404[i /*9*/].f_1 == 0)
			if (Global_76404[i /*9*/].f_2 != 0f)
				Global_76404[i /*9*/].f_1 = BUILTIN::FLOOR(Global_76404[i /*9*/].f_2);
		...
		if (num > 0)
		{
			if (Global_64533[num /*13*/] == 9)
				Global_76404[i /*9*/].f_1 = BUILTIN::ROUND(fLocal_632);
					...
					if (Global_64316)
						if (Global_64318 == -1 || Global_76404[i /*9*/] == Global_64318)
							if (Global_76404[i /*9*/] == 339 || Global_76404[i /*9*/] == 179 || Global_76404[i /*9*/] == 342 || Global_76404[i /*9*/] == 234)
								Global_76404[i /*9*/].f_1 = Global_76404[i /*9*/].f_1 + BUILTIN::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_76404[i /*9*/].f_1 = Global_76404[i /*9*/].f_1 + iLocal_624;
					break;
