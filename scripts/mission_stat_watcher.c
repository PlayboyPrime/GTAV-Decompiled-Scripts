					...
					if (Global_64169)
					{
						...
						if (value2 > 0)
						{
							if (!_IS_MISSION_REPEAT_ACTIVE(false))
							{
								...
								{
									case 90:
										STATS::STAT_SET_INT(1466040336, value2, true);
										break;
								
									case 93:
										STATS::STAT_SET_INT(1379738874, value2, true);
										break;
								
									case 69:
									case 70:
										STATS::STAT_SET_INT(-1224628078, value2, true);
										break;
								
									case 84:
									case 85:
										STATS::STAT_SET_INT(898185716, value2, true);
										break;
								}
							}
...
{
	Global_64185 = false;
	Global_64189 = func_7(-669750575);
	Global_64188 = func_7(-2097237603);
	Global_64191 = func_7(-1901131717);
	Global_64190 = func_7(2020326774);
	Global_64193 = func_7(-1675981664);
	Global_64192 = func_7(165162477);
	return;
}
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	{
		case 0:
			STATS::STAT_SET_INT(-465206720, Global_113969.f_1.f_126[iParam0 /*23*/], true);
			break;
	}
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE1CF
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 0:
					STATS::STAT_SET_INT(651528675, iParam2, true);
					break;
			
				case 2:
					STATS::STAT_SET_INT(95007177, iParam2, true);
					break;
			
				case 4:
					STATS::STAT_SET_INT(-1200659905, iParam2, true);
					break;
			}
			break;
		...
		case 2:
			STATS::STAT_SET_INT(2086462943, iParam2, true);
			break;
	
		case 4:
			STATS::STAT_SET_INT(817170656, iParam2, true);
			break;
	
		case 3:
			STATS::STAT_SET_INT(1311246157, iParam2, true);
			break;
	
		case 5:
			STATS::STAT_SET_INT(-386015615, iParam2, true);
			break;
	
		case 6:
			STATS::STAT_SET_INT(-2062635962, iParam2, true);
			break;
	}
...
void func_103() // Position - 0xE456
{
	...
	value = 0;
	value2 = 0;
	value = func_7(-669750575) - Global_64189;
	value2 = func_7(-2097237603) - Global_64188;
	value = value + (func_7(-1901131717) - Global_64191);
	value2 = value2 + (func_7(2020326774) - Global_64190);
	value = value + (func_7(-1675981664) - Global_64193);
	value2 = value2 + (func_7(165162477) - Global_64192);
	SYSTEM::WAIT(0);
	num = 100f;
							...
							if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
							{
								...
								if (Global_64195 > 0)
								{
									...
									if (num3 != -1)
									{
										...
										{
											if (pedCauseOfDeath != 0 && pedCauseOfDeath != -1569615261)
											{
												func_111();
