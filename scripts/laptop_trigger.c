	...
	while (flag2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_145))
		{
			if (bLocal_136)
				if (!func_298(PLAYER::PLAYER_ID()))
					if (!_STOPWATCH_IS_INITIALIZED(&uLocal_139))
						func_296(&uLocal_139, true, false);
			...
			if (Global_1943773 && func_295(PLAYER::PLAYER_ID()) || func_294(PLAYER::PLAYER_ID()))
			{
				...
				else if (func_293(&uLocal_143, 10000, false))
				{
				...
				if (!flag3 && !Global_33358 && !func_278(0) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false) && !func_277() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vector, vector2, false, true, 1) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(obLocal_145) && !IS_BIT_SET(Global_2621446, 15) && !func_276() && !(Global_79539 && func_275()) && !(!Global_79539 && func_274()) && !(Global_79539 && IS_BIT_SET(Global_4718592.f_14, 24) && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && !(Global_79539 && func_273() && func_272()) && !(Global_79539 && func_271(PLAYER::PLAYER_ID()) == 5) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE() && !Global_78303 && !func_268() && !func_267() && flag5 && !func_264() && !func_263())
				{
					...
					if (iLocal_134 != -1 && func_234(iLocal_134, true) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()) && func_233())
					{
						...
						if (!flag)
						{
							...
							if (func_232() || func_231() || func_230())
							{
								func_21(&uLocal_141, false, false);
							
								while (!func_293(&uLocal_141, 500, false))
								{
									func_286(0);
									BUILTIN::WAIT(0);
								}
...
void func_21(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x11BD (4541)
{
...
int func_34(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x160C (5644)
{
	...
	if (!Global_21285 && !IS_BIT_SET(Global_8921, 9))
	{
		if (Global_21066.f_1 == 6)
		{
			...
			func_40(1);
			func_44(Global_21047, "DISPLAY_VIEW", 1f, BUILTIN::TO_FLOAT(Global_21046), -1082130432, -1082130432, -1082130432);
		}
	}
				...
				if (iParam0 == Global_8926[num /*15*/].f_11)
				{
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9504[i] == 0)
						{
							...
							if (Global_2696411)
								if (num == 14)
									func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(Global_23488), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9504[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(Global_23493), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79539)
								{
									...
									func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(value2), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21066)
									...
									func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(value3), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8926[num /*15*/].f_10 == 57 && num == 24)
							{
								...
								func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(value6), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_41(Global_21047, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_8926[num /*15*/].f_10), BUILTIN::TO_FLOAT(0), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
...
int func_104(BOOL bParam0, BOOL bParam1) // Position - 0x335D (13149)
{
	int address;
	int i;
	Player player;
...
BOOL func_111() // Position - 0x3539 (13625)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_112() // Position - 0x354F (13647)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_113(const char* sParam0, int iParam1, BOOL bParam2) // Position - 0x3565 (13669)
{
	if (bParam2)
	{
...
void func_114(const char* sParam0, BOOL bParam1) // Position - 0x3635 (13877)
{
	var unk;
...
void func_115(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, int iParam17) // Position - 0x3700 (14080)
{
	BOOL isBoss;
	int bossType;
	int bossId1;
...
int func_116(Player plParam0) // Position - 0x376A (14186)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_117(Player plParam0) // Position - 0x378F (14223)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x37B4 (14260)
{
	return Global_1887549[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_119(BOOL bParam0) // Position - 0x37C9 (14281)
{
	return func_224(PLAYER::PLAYER_ID(), bParam0);
}

void func_120(const char* sParam0, BOOL bParam1) // Position - 0x37DB (14299)
{
	var unk;
...
void func_121(int iParam0, const char* sParam1) // Position - 0x3877 (14455)
{
	Global_1981196[iParam0] = MISC::GET_HASH_KEY(sParam1);
	return;
}

void func_122(int iParam0, int iParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x388D (14477)
{
	Hash statName;
	Hash statName2;
	var value;
...
Hash func_123(int iParam0, int iParam1) // Position - 0x3920 (14624)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(3, iParam0, func_124(iParam1));
}

int func_124(int iParam0) // Position - 0x3935 (14645)
{
	int num;
	int num2;
...
const char* func_125(Player plParam0, BOOL bParam1) // Position - 0x3969 (14697)
{
	if (!bParam1)
		if (func_91(plParam0, true))
			return func_126();
...
const char* func_126() // Position - 0x3990 (14736)
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

struct<16> func_127(int iParam0, int iParam1, int iParam2) // Position - 0x39A0 (14752)
{
	Hash statHash;
	Hash statHash2;
	var unk;
...
void func_128() // Position - 0x39DD (14813)
{
	int i;
...
void func_129(var uParam0, int iParam1) // Position - 0x3A28 (14888)
{
	func_130(uParam0, iParam1);
	return;
}

void func_130(var uParam0, int iParam1) // Position - 0x3A38 (14904)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_131(int iParam0) // Position - 0x3A49 (14921)
{
	return Global_2672939.f_2590[0 /*80*/].f_1 == iParam0;
}

void func_132(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3A60 (14944)
{
	var userID;
	int cloudTimeAsInt;
	int num;
...
int func_133() // Position - 0x3D1B (15643)
{
...
int func_134() // Position - 0x3D37 (15671)
{
...
void func_135(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3D53 (15699)
{
	int num;
...
void func_136() // Position - 0x3ED1 (16081)
{
	var txdName;
	var subject;
...
int func_137(eCharacter echParam0, int iParam1) // Position - 0x3F4C (16204)
{
...
int func_138(eCharacter echParam0, int iParam1) // Position - 0x3F76 (16246)
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_139(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3FA0 (16288)
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_140(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3FE5 (16357)
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x402C (16428)
{
...
void func_142() // Position - 0x4048 (16456)
{
	BOOL flag;
...
void func_143() // Position - 0x40DE (16606)
{
	Global_1048576.f_10 = 0;
	return;
}

void func_144() // Position - 0x40ED (16621)
{
	var unk;
	var unk2;
	var unk3;
...
void func_145() // Position - 0x4424 (17444)
{
	MISC::SET_BIT(&(Global_2684718.f_2), 12);
	return;
}

void func_146() // Position - 0x4438 (17464)
{
	Global_1057440 = -1;
	return;
}

BOOL func_147() // Position - 0x4445 (17477)
{
	switch (func_148())
	{
		case 21:
...
int func_148() // Position - 0x44E5 (17637)
{
	return Global_1057440;
}

void func_149(BOOL bParam0) // Position - 0x44F1 (17649)
{
	BOOL flag;
...
void func_150(int iParam0) // Position - 0x4584 (17796)
{
	Global_2684718.f_892 = iParam0;
	return;
}

void func_151(int iParam0) // Position - 0x4595 (17813)
{
	if (iParam0 == -1)
...
void func_152() // Position - 0x45BF (17855)
{
	Global_2684718.f_9 = -1;
	return;
}

BOOL func_153() // Position - 0x45CE (17870)
{
	return Global_2684718.f_739;
}

void func_154() // Position - 0x45DD (17885)
{
	Global_2684718.f_42 = func_155();
	return;
}

int func_155() // Position - 0x45EF (17903)
{
	if (Global_2692732)
		return 32;
...
void func_156() // Position - 0x460A (17930)
{
	Global_2684718.f_737 = 0;
	return;
}

void func_157() // Position - 0x461A (17946)
{
	Global_2684718.f_719 = 0;
	return;
}

void func_158() // Position - 0x462A (17962)
{
	MISC::CLEAR_BIT(&(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18), 15);
	return;
}

void func_159() // Position - 0x4647 (17991)
{
...
void func_160() // Position - 0x465D (18013)
{
	MISC::SET_BIT(&(Global_2684718.f_3), 2);
	return;
}

void func_161() // Position - 0x4670 (18032)
{
	MISC::CLEAR_BIT(&Global_2684718, 7);
	return;
}

void func_162() // Position - 0x4681 (18049)
{
	MISC::CLEAR_BIT(&Global_2684718, 6);
	return;
}

void func_163() // Position - 0x4692 (18066)
{
	Global_2684718 = 0;
...
void func_164(BOOL bParam0) // Position - 0x46AD (18093)
{
	int i;
	var unk;
	int j;
...
void func_165() // Position - 0x47A9 (18345)
{
	Global_2680839.f_32 = 0;
	return;
}

void func_166() // Position - 0x47B8 (18360)
{
	var unk;
	int i;
...
BOOL func_167() // Position - 0x4832 (18482)
{
	return IS_BIT_SET(Global_2684718.f_3, 2);
}

void func_168() // Position - 0x4842 (18498)
{
	MISC::CLEAR_BIT(&(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18), 5);
	return;
}

void func_169() // Position - 0x485E (18526)
{
	MISC::CLEAR_BIT(&(Global_2684718.f_2), 11);
	return;
}

BOOL func_170() // Position - 0x4872 (18546)
{
	return IS_BIT_SET(Global_2684718.f_2, 27);
}

BOOL func_171() // Position - 0x4883 (18563)
{
...
BOOL func_172() // Position - 0x48B5 (18613)
{
	return IS_BIT_SET(Global_2684718, 1);
}

BOOL func_173() // Position - 0x48C3 (18627)
{
	return IS_BIT_SET(Global_2684718, 2);
}

BOOL func_174() // Position - 0x48D1 (18641)
{
	return IS_BIT_SET(Global_2684718, 20);
}

BOOL func_175() // Position - 0x48E0 (18656)
{
	return IS_BIT_SET(Global_2685658.f_1.f_2810, 3);
}

void func_176() // Position - 0x48F3 (18675)
{
...
void func_177() // Position - 0x4914 (18708)
{
	var unk;
...
void func_178() // Position - 0x495D (18781)
{
	var unk;
...
void func_179(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x49A6 (18854)
{
	Hash statName;
...
Hash func_180(int iParam0, int iParam1) // Position - 0x49D4 (18900)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_124(iParam1));
}

void func_181(int iParam0) // Position - 0x49E9 (18921)
{
...
void func_182() // Position - 0x4A13 (18963)
{
	int i;
...
BOOL func_183() // Position - 0x4A74 (19060)
{
	return Global_2684718.f_742;
}

void func_184(int iParam0) // Position - 0x4A83 (19075)
{
	int num;
	int offset;
...
BOOL func_185(int iParam0) // Position - 0x4AAC (19116)
{
	int num;
	int num2;
...
void func_186(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4AD2 (19154)
{
	if (func_193())
	{
		if (iParam1 == 1)
		{
			...
			func_21(&(Global_2739811.f_4528), false, false);
			...
			if (bParam2)
			{
				...
				func_21(&(Global_2739811.f_4531), false, false);
			}
			else
			{
...
BOOL func_187(Player plParam0) // Position - 0x4B9C (19356)
{
...
BOOL func_188(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4BC1 (19393)
{
	if (bParam1)
...
BOOL func_189(Player plParam0) // Position - 0x4BF3 (19443)
{
	return func_190(plParam0);
}

BOOL func_190(Player plParam0) // Position - 0x4C01 (19457)
{
	return IS_BIT_SET(Global_1845221[plParam0 /*889*/].f_11.f_1, 0);
}

BOOL func_191() // Position - 0x4C18 (19480)
{
	return Global_2684718.f_844;
}

void func_192(BOOL bParam0) // Position - 0x4C27 (19495)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_193())
...
BOOL func_193() // Position - 0x4D20 (19744)
{
	return Global_1574582;
}

void func_194() // Position - 0x4D2C (19756)
{
	int i;
	Player player;
...
void func_195(Player plParam0) // Position - 0x4D6E (19822)
{
	Ped playerPed;
...
void func_196(BOOL bParam0, Player plParam1) // Position - 0x4DD0 (19920)
{
...
int func_197(Player plParam0, Player plParam1) // Position - 0x4F71 (20337)
{
	int i;
...
Player func_198(Player plParam0, int iParam1) // Position - 0x4FC7 (20423)
{
	if (func_281(plParam0))
...
BOOL func_199(Player plParam0, Player plParam1) // Position - 0x5003 (20483)
{
	if (plParam1 != _INVALID_PLAYER_INDEX())
...
void func_200(int iParam0) // Position - 0x503C (20540)
{
	if (!func_215())
		return;
...
int func_201(Player plParam0) // Position - 0x5084 (20612)
{
...
int func_202(Player plParam0) // Position - 0x50A5 (20645)
{
	return Global_1887549[plParam0 /*611*/].f_10.f_1;
}

int func_203(int iParam0, int iParam1) // Position - 0x50BA (20666)
{
	Hash statHash;
	int outValue;
...
void func_204() // Position - 0x50E9 (20713)
{
...
void func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x511A (20762)
{
	Global_2685658.f_3078.f_2 = { uParam0 };
	return;
}

void func_206(var uParam0, var uParam1) // Position - 0x5133 (20787)
{
...
void func_207(BOOL bParam0) // Position - 0x5163 (20835)
{
	func_208(204, bParam0, -1, true);
	return;
}

void func_208(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5175 (20853)
{
	Hash statName;
...
Hash func_209(int iParam0, int iParam1) // Position - 0x5198 (20888)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_124(iParam1));
}

void func_210(BOOL bParam0) // Position - 0x51AD (20909)
{
	if (bParam0)
	{
		if (func_212(4))
...
void func_211(BOOL bParam0) // Position - 0x5215 (21013)
{
	func_208(432, bParam0, -1, true);
	return;
}

BOOL func_212(int iParam0) // Position - 0x5228 (21032)
{
	return IS_BIT_SET(Global_2739811.f_5265.f_50, iParam0);
}

struct<16> func_213(int iParam0) // Position - 0x523C (21052)
{
	var unk;
...
const char* func_214(int iParam0) // Position - 0x527F (21119)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_215() // Position - 0x52A3 (21155)
{
...
var func_216(int iParam0) // Position - 0x52C1 (21185)
{
	return Global_1574538[iParam0];
}

var func_217() // Position - 0x52D1 (21201)
{
	return func_216(func_65() + 1);
}

BOOL func_218(Player plParam0) // Position - 0x52E3 (21219)
{
	return func_219(plParam0) > 0;
}

int func_219(Player plParam0) // Position - 0x52F3 (21235)
{
	int num;
	int num2;
...
var func_220() // Position - 0x5348 (21320)
{
	return Global_262145.f_15358;
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x5357 (21335)
{
	Hash statHash;
	int outValue;
...
int func_222() // Position - 0x5375 (21365)
{
	return Global_262145.f_12821;
}

int func_223() // Position - 0x5384 (21380)
{
	int i;
	int num;
	Player player;
...
BOOL func_224(Player plParam0, BOOL bParam1) // Position - 0x53C1 (21441)
{
	if (!func_66(plParam0))
		return false;
...
void func_225() // Position - 0x53F9 (21497)
{
	var unk;
		...
		if (func_7(0, &unk))
		{
			while (!flag)
			{
				...
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_141))
					func_296(&uLocal_141, false, false);
				else if (func_293(&uLocal_141, 4000, false))
					flag = true;
...
void func_226(Object obParam0) // Position - 0x554A (21834)
{
	var animDict;
	var animDict2;
	var animDict3;
...
BOOL func_227(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x5A94 (23188)
{
...
BOOL func_228(Ped pedParam0) // Position - 0x5AC7 (23239)
{
...
BOOL func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x5AE7 (23271)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_230() // Position - 0x5B62 (23394)
{
...
BOOL func_231() // Position - 0x5B84 (23428)
{
...
BOOL func_232() // Position - 0x5BB7 (23479)
{
...
BOOL func_233() // Position - 0x5BEA (23530)
{
...
BOOL func_234(int iParam0, BOOL bParam1) // Position - 0x5C39 (23609)
{
	int num;
...
int func_235(int iParam0) // Position - 0x5CF1 (23793)
{
	int i;
...
void func_236(BOOL bParam0) // Position - 0x5D2C (23852)
{
...
BOOL func_237() // Position - 0x5D6C (23916)
{
	return Global_1943917.f_740;
}

void func_238(BOOL bParam0) // Position - 0x5D7B (23931)
{
	if (func_260(PLAYER::PLAYER_ID()) && func_246(PLAYER::PLAYER_ID()) == func_245(PLAYER::PLAYER_ID()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_237() && !Global_1943773)
	{
		...
		else if (_STOPWATCH_IS_INITIALIZED(&uLocal_139) && func_293(&uLocal_139, 10000, true) || !bLocal_136)
		{
...
BOOL func_239(Player plParam0) // Position - 0x5EF0 (24304)
{
	return func_240(func_87(plParam0));
}

BOOL func_240(int iParam0) // Position - 0x5F02 (24322)
{
	switch (iParam0)
	{
		case 178:
...
void func_241(char* sParam0) // Position - 0x5F22 (24354)
{
...
BOOL func_242() // Position - 0x5F38 (24376)
{
	if (Global_1943778)
		return false;
...
BOOL func_243() // Position - 0x5F4F (24399)
{
	if (func_244())
		return 1;
...
BOOL func_244() // Position - 0x5F69 (24425)
{
	return Global_1575037 == 10;
}

int func_245(Player plParam0) // Position - 0x5F78 (24440)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
int func_246(Player plParam0) // Position - 0x5F9B (24475)
{
...
int func_247(int iParam0) // Position - 0x5FC2 (24514)
{
	switch (iParam0)
	{
		case 60:
...
void func_248(BOOL bParam0) // Position - 0x6057 (24663)
{
	if (func_259(PLAYER::PLAYER_ID()) || func_231() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_237() && !Global_1943773 && func_279(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(obLocal_145), 90f))
	{
		...
		{
			if (_STOPWATCH_IS_INITIALIZED(&uLocal_139) && func_293(&uLocal_139, 10000, true) || !bLocal_136)
			{
...
BOOL func_249(Player plParam0) // Position - 0x61C6 (25030)
{
	return func_250(func_87(plParam0));
}

BOOL func_250(int iParam0) // Position - 0x61D8 (25048)
{
	switch (iParam0)
	{
		case 190:
...
BOOL func_251() // Position - 0x61FE (25086)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_145))
	{
...
BOOL func_252(Player plParam0) // Position - 0x623C (25148)
{
...
BOOL func_253(Player plParam0) // Position - 0x625F (25183)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_254(BOOL bParam0) // Position - 0x62BF (25279)
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x641A (25626)
{
	int i;
...
BOOL func_256() // Position - 0x6545 (25925)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x65E9 (26089)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_258(var uParam0) // Position - 0x65FC (26108)
{
	int num;
...
BOOL func_259(Player plParam0) // Position - 0x6653 (26195)
{
...
BOOL func_260(Player plParam0) // Position - 0x668C (26252)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_261(int iParam0, int iParam1) // Position - 0x66D2 (26322)
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_262(int iParam0) // Position - 0x67AF (26543)
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_263() // Position - 0x67DE (26590)
{
	return Global_78315;
}

BOOL func_264() // Position - 0x67EA (26602)
{
...
int func_265(int iParam0) // Position - 0x6918 (26904)
{
	int i;
...
int func_266(int iParam0) // Position - 0x6943 (26947)
{
	if (iParam0 != -1)
...
BOOL func_267() // Position - 0x6962 (26978)
{
	return IS_BIT_SET(Global_1943917.f_11, 1);
}

BOOL func_268() // Position - 0x6972 (26994)
{
...
BOOL func_269(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x69AF (27055)
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), fParam1) <= fParam4 * fParam4;
}

int func_270(Player plParam0) // Position - 0x69CD (27085)
{
	Player player;
...
int func_271(Player plParam0) // Position - 0x69EC (27116)
{
...
BOOL func_272() // Position - 0x6A09 (27145)
{
	return func_281(PLAYER::PLAYER_ID());
}

BOOL func_273() // Position - 0x6A19 (27161)
{
	return Global_1845221[PLAYER::PLAYER_ID() /*889*/] == 148;
}

BOOL func_274() // Position - 0x6A2F (27183)
{
	return Global_76641;
}

BOOL func_275() // Position - 0x6A3B (27195)
{
	return Global_1929312;
}

BOOL func_276() // Position - 0x6A47 (27207)
{
...
BOOL func_277() // Position - 0x6A75 (27253)
{
...
BOOL func_278(int iParam0) // Position - 0x6A8F (27279)
{
	if (iParam0 == 1)
...
BOOL func_279(float fParam0, float fParam1, float fParam2) // Position - 0x6AE6 (27366)
{
	float num;
	float num2;
...
BOOL func_280() // Position - 0x6B5B (27483)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_145))
		if (func_295(PLAYER::PLAYER_ID()))
			return 1;
...
BOOL func_281(Player plParam0) // Position - 0x6B7C (27516)
{
	if (func_66(plParam0))
		if (func_66(Global_1887549[plParam0 /*611*/].f_10))
...
BOOL func_282() // Position - 0x6BB1 (27569)
{
...
BOOL func_283() // Position - 0x6BD4 (27604)
{
...
BOOL func_284(Player plParam0) // Position - 0x6BF7 (27639)
{
	if (func_261(Global_1845221[plParam0 /*889*/].f_268.f_36, -1))
		return 1;
...
BOOL func_285() // Position - 0x6C1A (27674)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_145))
...
void func_286(int iParam0) // Position - 0x6C4D (27725)
{
	if (func_291())
		return;
...
void func_287(int iParam0) // Position - 0x6C80 (27776)
{
	if (func_291())
		return;
...
BOOL func_288() // Position - 0x6D0A (27914)
{
...
void func_289(BOOL bParam0, BOOL bParam1) // Position - 0x6D31 (27953)
{
	if (bParam0)
	{
		if (func_278(0))
...
BOOL func_290() // Position - 0x6DA5 (28069)
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_291() // Position - 0x6DB3 (28083)
{
	return IS_BIT_SET(Global_1957675, 19);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6DC2 (28098)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_293(var uParam0, int iParam1, BOOL bParam2) // Position - 0x6DCF (28111)
{
	if (iParam1 == -1)
		return true;
...
BOOL func_294(Player plParam0) // Position - 0x6E2D (28205)
{
	int num;
...
BOOL func_295(Player plParam0) // Position - 0x6E82 (28290)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
...
void func_296(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6EC8 (28360)
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x6F0D (28429)
{
	return uParam0->f_1;
}

BOOL func_298(Player plParam0) // Position - 0x6F19 (28441)
{
	return func_299(func_87(plParam0));
}

BOOL func_299(int iParam0) // Position - 0x6F2B (28459)
{
	switch (iParam0)
	{
		case 167:
...
BOOL func_300(int iParam0) // Position - 0x6F51 (28497)
{
	return Global_44181 == iParam0;
}

void func_301() // Position - 0x6F5F (28511)
{
	if (iLocal_134 != -1)
		func_258(&iLocal_134);
