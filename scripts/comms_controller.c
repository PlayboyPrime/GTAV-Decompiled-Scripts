...
int func_58(var uParam0) // Position - 0x1E74
{
	...
	for (i = 0; i < Global_113969.f_7691.f_910; i = i + 1)
	{
		if (Global_113969.f_7691.f_867[i /*14*/] == uParam0)
			return i;
	}
	...
	if (Global_44589 != -1)
	{
		...
		else
		{
			...
			if (IS_BIT_SET(Global_113969.f_7691[Global_44589 /*15*/].f_1, 15))
			{
				...
				func_13(Global_113969.f_7691[Global_44589 /*15*/].f_6, num);
...
void func_193(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7EC6
{
	...
	if (!bParam2)
	{
		...
		Global_54207[iParam0 /*120*/].f_86[num] = 0;
	...
	else
	{
		...
		Global_54207[iParam0 /*120*/].f_35[num] = 0;
		Global_54207[iParam0 /*120*/].f_86[num] = 1;
		Global_54207[iParam0 /*120*/].f_69[num] = false;
		Global_54207[iParam0 /*120*/] = Global_54207[iParam0 /*120*/] + 1;
