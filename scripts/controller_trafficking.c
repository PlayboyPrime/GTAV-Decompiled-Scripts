					...
					if (vehiclePedIsUsing2 == veLocal_52)
					{
						if (SYSTEM::VDIST2(uLocal_53, ENTITY::GET_ENTITY_COORDS(pedLocal_26, true)) < 100f)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(veLocal_27) && !ENTITY::IS_ENTITY_DEAD(veLocal_27, false))
								if (ENTITY::GET_ENTITY_MODEL(veLocal_27) != -1661854193 && ENTITY::GET_ENTITY_MODEL(veLocal_27) != -644710429)
...
void func_163(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xC26F
{
	if (func_162(&Global_78179.f_555[0 /*21*/], iParam0))
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(-644710429))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(veLocal_46))
				{
					...
					veLocal_46 = VEHICLE::CREATE_VEHICLE(-644710429, uLocal_48, 25.29f, true, true, false);
