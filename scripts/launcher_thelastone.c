...
BOOL func_86(Player plParam0) // Position - 0x758F
{
...
BOOL func_94(Player plParam0) // Position - 0x8447
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD45A
{
	...
	if (func_248(*panParam0) || func_246(*panParam0) || Global_79635 == 1)
		return true;
...
BOOL func_250(var uParam0) // Position - 0xEE2F
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_253(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1") || !WEAPON::HAS_WEAPON_ASSET_LOADED(487013001) || !WEAPON::HAS_WEAPON_ASSET_LOADED(100416529))
				return false;
