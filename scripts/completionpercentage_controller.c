						...
						if (!(Global_114135.f_10198[iLocal_420 /*12*/].f_6 == 0))
						{
							...
							if (Global_114135.f_10198[iLocal_420 /*12*/].f_6 == 9 || Global_114135.f_10198[iLocal_420 /*12*/].f_6 == 10)
							{
								if (Global_114135.f_10198[iLocal_420 /*12*/].f_5 || Global_113870 == 1)
								{
									...
									DATAFILE::DATADICT_SET_INT(uLocal_214[iLocal_398], "x", BUILTIN::ROUND(Global_114135.f_10198[iLocal_420 /*12*/].f_10));
									DATAFILE::DATADICT_SET_INT(uLocal_214[iLocal_398], "y", BUILTIN::ROUND(Global_114135.f_10198[iLocal_420 /*12*/].f_11));
...
void func_59(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xA75B (42843)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_52(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_52(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
{
	return BUILTIN::SHIFT_RIGHT(Global_114135.f_10198[iParam0 /*12*/].f_8, 7) & 127;
}
...
void func_153() // Position - 0x2302D (143405)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114135.f_10198.f_3853))
		func_156(13, BUILTIN::FLOOR(Global_114135.f_10198.f_3853));
