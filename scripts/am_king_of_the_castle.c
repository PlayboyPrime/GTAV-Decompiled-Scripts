...
void func_127(Player plParam0, Player plParam1, Player plParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, char* sParam10, int iParam11, var uParam12, var uParam13, var uParam14) // Position - 0x972B
{
	const char* playerName;
	int num;
	char* str;
...
void func_282(BOOL bParam0) // Position - 0xD5D5
{
	...
	else if (IS_BIT_SET(Global_1887305[PLAYER::PLAYER_ID() /*610*/].f_1, 0))
	{
		...
		else if (func_320(Global_2698686) == false)
		{
			...
			if (num > 0)
			{
				func_287(-2011184620, num);
				func_285(1934, 1, -1);
				func_287(-390324340, 1);
			}
		}
													...
													if (eventData.f_5)
													{
														if (num == NETWORK::PARTICIPANT_ID_TO_INT())
														{
															if (iLocal_3197 < func_649())
															{
																...
																func_605(0, pedIndexFromEntityIndex2, "", -1859646258, 2131309714, func_648(), 1, -1, 0, false, 0);
													...
													if (num == NETWORK::PARTICIPANT_ID_TO_INT())
													{
														...
														if (eventData.f_5)
														{
															if (iLocal_3195 < func_604())
															{
																...
																func_605(0, pedIndexFromEntityIndex2, "", -1859646258, 2131309714, func_603(), 1, -1, 0, false, 0);
			...
			if (!func_273(PLAYER::PLAYER_ID()))
			{
				if (!func_132(PLAYER::PLAYER_ID()))
				{
					if (func_513(NETWORK::PARTICIPANT_ID_TO_INT()))
					{
						...
						{
							func_679();
							func_605(0, PLAYER::PLAYER_PED_ID(), "", -1636175450, -1253457806, num2, 1, -1, 0, false, 0);
