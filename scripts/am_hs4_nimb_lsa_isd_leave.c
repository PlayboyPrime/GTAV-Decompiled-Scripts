...
BOOL func_146(int iParam0) // Position - 0xBB7B (47995)
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xBB9F (48031)
{
	int num;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0xBBBD (48061)
{
