...
BOOL func_142(int iParam0) // Position - 0xACE8
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0xAD0C
{
	int num;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0xAD2A
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == 1885233650)
		{
			...
			if (pedDrawableVariation > 15)
			{
				...
				if (num2 >= 237)
				{
					componentHash = func_186(1885233650, num2, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == -1667301416)
		{
			...
			else if (pedDrawableVariation > 15)
			{
				...
				if (num3 >= 256)
				{
					componentHash2 = func_186(-1667301416, num3, 11, 4);
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
void func_228(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1C60B
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_218(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_218(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
			...
			switch (pedDrawableVariation)
			{
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 7:
						case 12:
							num = func_271(1885233650, 11, func_190(pedParam0, 11, PV_COMP_INVALID), 0);
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num3 >= 241)
						{
							componentHash2 = func_186(1885233650, num3, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num4 = func_271(-1667301416, 11, func_190(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num5 >= 256)
						{
							componentHash3 = func_186(-1667301416, num5, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num6 = func_271(-1667301416, 11, func_190(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num7 = func_271(-1667301416, 11, func_190(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num8 >= 136)
						{
							componentHash4 = func_186(-1667301416, num8, 8, 4);
...
void func_296() // Position - 0x34610
{
	...
	func_304(&uLocal_100, -1295027632, "Plane_1");
