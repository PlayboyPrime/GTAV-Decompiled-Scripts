...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAB36
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_143() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, -2118308144) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_142(true)))
...
void func_171(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC164
{
	var unk;
	int characterType;
	BOOL flag;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == 1885233650)
		{
			...
			if (pedDrawableVariation > 15)
			{
				...
				if (num2 >= 237)
				{
					componentHash = func_190(1885233650, num2, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == -1667301416)
		{
			...
			else if (pedDrawableVariation > 15)
			{
				...
				if (num3 >= 256)
				{
					componentHash2 = func_190(-1667301416, num3, 11, 4);
...
Hash func_190(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x130BE
{
	var outProp;
	int componentId;
	int num;
...
int func_194(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13690
{
	int i;
	int j;
...
int func_195(Ped pedParam0, int iParam1) // Position - 0x13731
{
...
int func_197(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x137E8
{
	int pedPropIndex;
...
BOOL func_203(Ped pedParam0, int iParam1, int iParam2) // Position - 0x13C09
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_204(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14065
{
	Hash componentHash;
...
BOOL func_205(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1410E
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x141B6
{
	switch (hParam0)
	{
		case -1667301416:
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x14209
{
	var unk;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1480D
{
	switch (hParam0)
	{
		case 225514697:
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14A8A
{
	if (hParam0 == 225514697)
	{
		if (iParam1 == 6)
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14EAF
{
	switch (hParam0)
	{
		case 225514697:
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2) // Position - 0x151A2
{
	switch (hParam0)
	{
		case 225514697:
...
struct<14> func_219(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x17E2F
{
	func_265();
...
void func_232(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CE33
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_222(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_222(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
			...
			switch (pedDrawableVariation)
			{
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 7:
						case 12:
							num = func_275(1885233650, 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num3 >= 241)
						{
							componentHash2 = func_190(1885233650, num3, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num4 = func_275(-1667301416, 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num5 >= 256)
						{
							componentHash3 = func_190(-1667301416, num5, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num6 = func_275(-1667301416, 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num7 = func_275(-1667301416, 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						...
						if (num8 >= 136)
						{
							componentHash4 = func_190(-1667301416, num8, 8, 4);
...
int func_275(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3432D
{
	Hash componentHash;
...
void func_300() // Position - 0x34F5A
{
	...
	func_303(&uLocal_118, -1295027632, "Plane_1");
