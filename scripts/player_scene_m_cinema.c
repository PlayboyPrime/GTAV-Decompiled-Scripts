...
int func_7(int iParam0, Entity eParam1) // Position - 0x431
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_8(Global_101409) && eParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
