...
int func_12(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x9AF
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_65(entityModel, iParam1, iParam2, -1) };
...
{
	Global_79172[1 /*14*/] = { func_65(hParam0, iParam1, iParam2, -1) };
...
struct<14> func_65(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB543
{
	func_129();
...
BOOL func_72(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD854
{
	int num;
	int num2;
	int num3;
...
void func_75(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xD974
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_68(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_68(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_130(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1EDF0
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_130(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_130(pedParam0, 14, k))
											if (!func_18(entityModel, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_65(entityModel, i, num, -1) };
					
						if (!func_18(entityModel, iParam2, i, num, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_22(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_22(iParam1)))
	{
		return true;
	}
