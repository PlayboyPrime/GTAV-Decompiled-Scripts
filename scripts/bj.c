...
void main() // Position - 0x0
{
	...
	hasPedGotWeapon = WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), -72657034, false);
		...
		switch (num)
		{
			...
			case 5:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (hasPedGotWeapon)
					{
						if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), -72657034, false))
...
char* func_59(const char* sParam0) // Position - 0x5B9C
{
	return sParam0;
}
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x6C44
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x6CA2
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x6CE7
{
	return uParam0->f_1;
}
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6E99
{
	uParam0->f_1 = 0;
	return;
}
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xE7E5
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x15824
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_364(99, 1);
					func_255(-656546900, iParam3);
					break;
			
				case 1:
					func_255(-2098183071, iParam3);
					break;
			
				case 2:
					func_255(1578119842, iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_255(-1190521599, iParam3);
							break;
					
						case 1:
							func_255(490143716, iParam3);
							break;
					
						case 2:
							func_255(121069433, iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_255(219506691, iParam3);
							break;
					
						case 1:
							func_255(1871505786, iParam3);
							break;
					
						case 2:
							func_255(-2024399847, iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_255(27639974, iParam3);
							break;
					
						case 1:
							func_255(422258364, iParam3);
							break;
					
						case 2:
							func_255(316202960, iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_255(1806738963, iParam3);
							break;
					
						case 1:
							func_255(1576781520, iParam3);
							break;
					
						case 2:
							func_255(671882196, iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case -123529621:
							...
							{
								case 0:
									func_255(408653638, iParam3);
									break;
							
								case 1:
									func_255(-424799277, iParam3);
									break;
							
								case 2:
									func_255(-558138038, iParam3);
									break;
							}
							break;
						...
						case -1215733929:
							...
							{
								case 0:
									func_255(2038531975, iParam3);
									break;
							
								case 1:
									func_255(-572903575, iParam3);
									break;
							
								case 2:
									func_255(-953947924, iParam3);
									break;
							}
						...
						case 468388854:
							...
							{
								case 0:
									func_255(-445823242, iParam3);
									break;
							
								case 1:
									func_255(-1386757215, iParam3);
									break;
							
								case 2:
									func_255(-727828275, iParam3);
									break;
							}
							break;
						...
						case 499562112:
							...
							{
								case 0:
									func_255(-1744069936, iParam3);
									break;
							
								case 1:
									func_255(799609312, iParam3);
									break;
							
								case 2:
									func_255(181688102, iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_255(-330339780, iParam3);
					break;
			
				case 1:
					func_255(1697564429, iParam3);
					break;
			
				case 2:
					func_255(1674823841, iParam3);
					break;
			}
			break;
...
void func_311(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x1A9CC
{
	if (func_308(&Global_78179.f_555[0 /*21*/], iParam0))
	{
...
int func_317(Vehicle veParam0) // Position - 0x1ACC0
{
	int i;
...
void func_348(Hash* phParam0) // Position - 0x1BDAB
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (*phParam0 != 0 && *phParam0 != -1569615261 && *phParam0 != -1833087301 && *phParam0 != -72657034 && *phParam0 != 966099553)
			WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), -1569615261, -1, false, true);
...
void func_416(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1E8EF
{
...
void func_437(var uParam0, var uParam1, var uParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, Vehicle* pveParam6, Vehicle* pveParam7, var uParam8, Ped* ppedParam9, Hash hParam10, Hash hParam11, int* piParam12, int iParam13, var uParam14) // Position - 0x1F015
{
	...
	else if (modelHash != 0)
	{
		...
		if (func_441(_STOPWATCH_IS_INITIALIZED_0(uParam0)))
		{
			...
			{
				*pveParam6 = VEHICLE::CREATE_VEHICLE(-1352468814, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*pveParam4, 0f, -10f, 0f), func_442(uParam0), true, true, false);
...
void func_447(var uParam0, var uParam1, int iParam2) // Position - 0x1FD5B
{
	...
	else
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(pedInVehicleSeat))
			pedInVehicleSeat = PED::CREATE_PED_INSIDE_VEHICLE(vehicle, PED_TYPE_MISSION, -1422914553, -1, true, true);
...
void func_469(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x20447
{
	...
	if (hash != 0)
	{
		*uParam4 = func_471(iParam1);
		...
		func_472(uParam2, -1352468814);
	}

	if (func_368(hash))
	{
		func_472(uParam2, 1030400667);
		func_472(uParam2, 184361638);
		func_472(uParam2, 642617954);
		func_472(uParam2, 920453016);
		func_472(uParam2, 240201337);
		func_472(uParam2, 586013744);
		func_472(uParam2, 868868440);
	}
...
void func_479(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x20B20
{
	...
	{
		func_484(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vector, vector2, 1115815936, false, 2), true);
	}
	else
	{
	...
	{
		func_484(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vector, vector2, 1115815936, false, 2), true);
	}
	else
	{
