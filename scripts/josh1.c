	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(94130617))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_145))
				{
					...
					obLocal_145 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, 546378757, true, false, true);
				}
		...
		case 2:
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
			{
				...
				if (iLocal_160 == 0)
					PED::FORCE_PED_MOTION_STATE(uLocal_81.f_28[0], -668482597, false, 0, true);
			}
...
ePedComponentType func_77(int iParam0) // Position - 0x9989
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, int iParam1) // Position - 0x9A39
{
	int i;
	var unk;
...
struct<17> func_81(Hash hParam0, int iParam1) // Position - 0xA4DA
{
	int i;
	var unk;
...
struct<14> func_85(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC630
{
	func_149();
...
BOOL func_92(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE986
{
	int num;
	int num2;
	int num3;
...
void func_234(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28458
{
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!bLocal_158)
				{
					...
					if (func_300(uLocal_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_145))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_145);
						PED::FORCE_PED_MOTION_STATE(uLocal_81.f_28[0], -1871534317, false, 1, true);
						bLocal_158 = true;
					}
				}
			}
...
int func_309(var uParam0, eCharacter echParam1) // Position - 0x2B4E4
{
	int num;
