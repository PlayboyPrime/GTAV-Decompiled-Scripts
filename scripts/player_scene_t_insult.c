			...
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, &uLocal_344, &uLocal_393[iParam1 /*16*/], 2))
				{
					...
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_344, &uLocal_393[iParam1 /*16*/], "WalkInterruptible", &num, &num2) || func_35(&uLocal_344, &uLocal_393[iParam1 /*16*/], "WalkInterruptible", &num, &num2))
					{
						...
						if (synchronizedScenePhase > num)
						{
							...
							moveBlendRatio = 1f;
							motionStateHash = -668482597;
						
							if (iLocal_69 == 263)
							{
								moveBlendRatio = 2f;
								motionStateHash = -530524;
				...
				else
				{
					...
					else
					{
						...
						if (iLocal_255[0] == 1052341626 || iLocal_255[1] == 1052341626)
						{
							if (!func_31(flags, 4))
								func_30(&flags, 4);
...
int func_39(int iParam0, Entity eParam1) // Position - 0x1D61
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_40(Global_101409) && eParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
...
void func_48() // Position - 0x2171
{
	...
	switch (iLocal_69)
	{
		case 237:
			...
			uLocal_293[0] = 50f;
			uLocal_293[1] = 50f;
			iLocal_242[0] = 1381498905;
			iLocal_242[1] = 1381498905;
			uLocal_245[0] = -1;
			uLocal_245[1] = -1;
			break;
		...
		case 235:
			...
			if (clockHours < 8 || clockHours > 20)
				iLocal_242[0] = 1846523796;
			else
				iLocal_242[0] = 1381498905;
		
			iLocal_242[1] = 587703123;
			uLocal_245[0] = -1;
			uLocal_245[1] = 0;
			break;
		...
		case 247:
			...
			iLocal_242[0] = -945854168;
			iLocal_242[1] = -771835772;
			uLocal_245[0] = -1;
			uLocal_245[1] = -1;
			iLocal_255[0] = 1280564504;
			uLocal_258[0 /*3*/] = { 0f, 0f, -1f };
			uLocal_265[0 /*3*/] = { 0f, 0f, 2.16f };
			iLocal_255[1] = 1280564504;
		...
		case 288:
			...
			uLocal_290[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_293[0] = 0f;
			iLocal_242[0] = 2120901815;
			uLocal_245[0] = -1;
			iLocal_255[0] = 1052341626;
		...
		default:
			...
			uLocal_290[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_290[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_242[0] = 1264920838;
			iLocal_242[1] = 1264920838;
			uLocal_245[0] = -1;
			uLocal_245[1] = -1;
			break;
	}
