...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8FE6 (36838)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8FFC (36860)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9054 (36948)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB56E (46446)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE73 (48755)
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_207(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBA3 (56227)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE56F (58735)
{
	var unk;
...
var func_294(var uParam0) // Position - 0x14BF2 (84978)
{
	return uParam0;
}

struct<6> func_295(int iParam0, BOOL bParam1) // Position - 0x14BFC (84988)
{
	var unk;
...
BOOL func_296(var uParam0) // Position - 0x157B2 (87986)
{
	int num;
	int i;
	int num2;
...
BOOL func_297(int iParam0) // Position - 0x15A53 (88659)
{
	var unk;
	eCharacter character;
...
BOOL func_298(int iParam0) // Position - 0x15AA4 (88740)
{
	const char* string2;
...
BOOL func_299(int iParam0) // Position - 0x15B5D (88925)
{
	var unk;
...
BOOL func_300(int iParam0) // Position - 0x15C1E (89118)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_301(int iParam0, char* sParam1) // Position - 0x15CA3 (89251)
{
...
BOOL func_302(int iParam0) // Position - 0x15D85 (89477)
{
...
BOOL func_303(int iParam0) // Position - 0x15DB0 (89520)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_304(int iParam0) // Position - 0x15DDB (89563)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x15E06 (89606)
{
	if (func_256(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_306() // Position - 0x15E3B (89659)
{
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x15E55 (89685)
{
	int i;
...
BOOL func_308(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x15EBA (89786)
{
	int num;
	char* str;
...
BOOL func_309(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x15F32 (89906)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_310(var uParam0, var uParam1, BOOL bParam2) // Position - 0x15FAD (90029)
{
	char* str;
...
void func_311(char* sParam0) // Position - 0x16097 (90263)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_212(sParam0))
			func_312();
...
void func_312() // Position - 0x160B6 (90294)
{
	Global_21291 = 0;
	func_313();
	return;
...
void func_313() // Position - 0x160C6 (90310)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23436 = 0;
...
int func_314(var uParam0) // Position - 0x160E7 (90343)
{
	if (func_217(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_315(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1611D (90397)
{
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x1613D (90429)
{
	func_317(&(uParam0->f_41), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x1614F (90447)
{
	int i;
...
void func_318(Object* pobParam0, BOOL bParam1) // Position - 0x1618D (90509)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_319(var uParam0, BOOL bParam1) // Position - 0x161C8 (90568)
{
	func_320(&(uParam0->f_35), bParam1);
	return;
}

void func_320(var uParam0, BOOL bParam1) // Position - 0x161DA (90586)
{
	int i;
...
void func_321(Vehicle* pveParam0) // Position - 0x16217 (90647)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_322(var uParam0, int iParam1) // Position - 0x1624F (90703)
{
	func_323(&(uParam0->f_28), iParam1);
	return;
}

void func_323(var uParam0, int iParam1) // Position - 0x16261 (90721)
{
	int i;
...
void func_324(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x162A2 (90786)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_325(var uParam0) // Position - 0x162F2 (90866)
{
...
BOOL func_326(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x16343 (90947)
{
...
void func_327(var uParam0) // Position - 0x16376 (90998)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[0]))
...
void func_328(int iParam0) // Position - 0x16405 (91141)
{
	if (*iParam0 == -1)
		return;
...
void func_329(char* sParam0) // Position - 0x16442 (91202)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_330(var uParam0) // Position - 0x16454 (91220)
{
	*uParam0 = -1;
...
void func_331() // Position - 0x16487 (91271)
{
...
Hash func_332(eCharacter echParam0) // Position - 0x164A1 (91297)
{
	if (!func_36(echParam0))
