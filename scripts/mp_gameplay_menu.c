...
char* func_70(char* sParam0) // Position - 0x5CDE
{
	return sParam0;
}
...
BOOL func_82(var uParam0, int iParam1) // Position - 0x6221
{
...
BOOL func_87(int iParam0) // Position - 0x64F9
{
...
BOOL func_109(int iParam0) // Position - 0x6DD6
{
	switch (iParam0->f_9)
	{
		case 0:
