	...
	switch (iLocal_144)
	{
		...
		case 1:
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
			{
				...
				if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), 5f, false) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), -1568386805, 5f, false) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), -1312131151, 5f, false) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), -1813897027, 5f, false) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), 615608432, 5f, false) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], false), 1233104067, 5f, false))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
ePedComponentType func_103(int iParam0) // Position - 0xA2A1
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_104(Hash hParam0, int iParam1) // Position - 0xA351
{
	int i;
	var unk;
...
struct<17> func_107(Hash hParam0, int iParam1) // Position - 0xADF2
{
	int i;
	var unk;
...
struct<14> func_111(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCF46
{
	func_174();
...
BOOL func_175(Ped pedParam0, int iParam1, int iParam2) // Position - 0x205EB
{
	Hash entityModel;
	int num;
	int i;
...
void func_231(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13) // Position - 0x27ED2
{
	eCharacter character;
	BOOL flag;
	var txdName;
...
int func_325(var uParam0, eCharacter echParam1) // Position - 0x2C224
{
	int num;
