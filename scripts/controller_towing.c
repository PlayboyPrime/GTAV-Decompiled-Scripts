			...
			case 18:
				if (Global_101533 == 10)
				{
					if (Global_101567)
					{
						...
						if (hLocal_269 == -1323100960)
						{
							STREAMING::REQUEST_MODEL(-1323100960);
						}
						else if (hLocal_269 == -442313018)
						{
...
void func_142(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x9D63
{
		...
		case 0:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(pedParam0, false))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
				{
					...
					if (entityModel == -1323100960 || entityModel == -442313018 && ENTITY::GET_ENTITY_HEALTH(vehiclePedIsIn) > 400)
						return;
				}
			}
		...
		case 2:
			if (STREAMING::HAS_MODEL_LOADED(-1323100960))
			{
				if (!CAM::IS_SPHERE_VISIBLE(uLocal_256, fLocal_259) || func_22(Global_113969.f_19976.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(veLocal_273))
					{
						veLocal_273 = VEHICLE::CREATE_VEHICLE(-1323100960, vParam1, fParam4, true, true, false);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1323100960);
						iLocal_73 = 3;
					}
				}
