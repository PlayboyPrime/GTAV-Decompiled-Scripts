...
void func_83(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x284A (10314)
{
	...
	if (bParam3)
	{
		...
		{
			func_122(Global_24131.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
...
void func_96(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x5C84 (23684)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_122(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x7000 (28672)
{
	int num;
	float num2;
	float num3;
...
int func_131() // Position - 0x7607 (30215)
{
...
void func_135() // Position - 0x7872 (30834)
{
	...
	func_122(1, "RACES_OPT_MP" /*Play Online*/, 0, true, 0, false, 0);
