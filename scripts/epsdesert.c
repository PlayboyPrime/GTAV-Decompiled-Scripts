...
int func_11(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA2F
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_64(entityModel, iParam1, iParam2, -1) };
...
{
	Global_79172[1 /*14*/] = { func_64(hParam0, iParam1, iParam2, -1) };
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							if (num6 >= 5 && num6 <= 8 || num6 >= 25 && num6 <= 40 || num6 >= 42 && num6 <= 43)
								if (!func_24(-1692214353, num4, num6, num5, &num7))
									if (num7 != -99)
										num = num7;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_33(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_33(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_33(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_33(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
struct<14> func_64(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB5ED
{
	func_127();
...
void func_73(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xDA17
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_67(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_67(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F493
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_140(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_140(pedParam0, 14, k))
											if (!func_17(entityModel, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_64(entityModel, i, num, -1) };
					
						if (!func_17(entityModel, iParam2, i, num, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_21(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_21(iParam1)))
	{
		return true;
	}
...
BOOL func_170() // Position - 0x20165
{
	...
	for (i = 0; i < pedNearbyPeds; i = i + 1)
	{
		...
		{
			if (ENTITY::GET_ENTITY_MODEL(sizeAndPeds[i]) == -847807830)
			{
	...
	for (i = 0; i < pedNearbyPeds; i = i + 1)
	{
		if (func_162(sizeAndPeds[i]))
		{
			if (ENTITY::GET_ENTITY_MODEL(sizeAndPeds[i]) == func_173(55))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(pedLocal_37, 1862763509);
	...
	for (i = 0; i < pedNearbyPeds; i = i + 1)
	{
		if (func_162(sizeAndPeds[i]))
		{
			if (ENTITY::GET_ENTITY_MODEL(sizeAndPeds[i]) == func_173(CHAR_MARNIE))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(pedLocal_36, 1862763509);
...
void func_177() // Position - 0x204BC
{
	...
	if (Global_113969.f_10052.f_107 >= fLocal_210 || func_175(94) == true)
	{
		...
		if (outValue < 19)
		{
			STATS::STAT_SET_INT(-1016034844, 19, true);
			func_183(23, 19);
		}
