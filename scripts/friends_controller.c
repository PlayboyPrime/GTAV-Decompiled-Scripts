...
int func_109(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x480A
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_161(entityModel, iParam1, iParam2, -1) };
...
{
	Global_79172[1 /*14*/] = { func_161(hParam0, iParam1, iParam2, -1) };
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							if (num6 >= 5 && num6 <= 8 || num6 >= 25 && num6 <= 40 || num6 >= 42 && num6 <= 43)
								if (!func_122(-1692214353, num4, num6, num5, &num7))
									if (num7 != -99)
										num = num7;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
struct<14> func_161(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF48B
{
	func_224();
...
void func_170(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x118F5
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, -2050632586, 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, -2050632586, 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_225(Ped pedParam0, int iParam1, int iParam2) // Position - 0x22E36
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_225(pedParam0, 14, k))
											if (!func_115(entityModel, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_161(entityModel, i, num, -1) };
					
						if (!func_115(entityModel, iParam2, i, num, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_119(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_119(iParam1)))
	{
		return true;
	}
...
int func_293(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x264BB
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_319(99, 1);
					func_318(-656546900, iParam3);
					break;
			
				case 1:
					func_318(-2098183071, iParam3);
					break;
			
				case 2:
					func_318(1578119842, iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_318(-1190521599, iParam3);
							break;
					
						case 1:
							func_318(490143716, iParam3);
							break;
					
						case 2:
							func_318(121069433, iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_318(219506691, iParam3);
							break;
					
						case 1:
							func_318(1871505786, iParam3);
							break;
					
						case 2:
							func_318(-2024399847, iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_318(27639974, iParam3);
							break;
					
						case 1:
							func_318(422258364, iParam3);
							break;
					
						case 2:
							func_318(316202960, iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_318(1806738963, iParam3);
							break;
					
						case 1:
							func_318(1576781520, iParam3);
							break;
					
						case 2:
							func_318(671882196, iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case -123529621:
							...
							{
								case 0:
									func_318(408653638, iParam3);
									break;
							
								case 1:
									func_318(-424799277, iParam3);
									break;
							
								case 2:
									func_318(-558138038, iParam3);
									break;
							}
							break;
						...
						case -1215733929:
							...
							{
								case 0:
									func_318(2038531975, iParam3);
									break;
							
								case 1:
									func_318(-572903575, iParam3);
									break;
							
								case 2:
									func_318(-953947924, iParam3);
									break;
							}
						...
						case 468388854:
							...
							{
								case 0:
									func_318(-445823242, iParam3);
									break;
							
								case 1:
									func_318(-1386757215, iParam3);
									break;
							
								case 2:
									func_318(-727828275, iParam3);
									break;
							}
							break;
						...
						case 499562112:
							...
							{
								case 0:
									func_318(-1744069936, iParam3);
									break;
							
								case 1:
									func_318(799609312, iParam3);
									break;
							
								case 2:
									func_318(181688102, iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_318(-330339780, iParam3);
					break;
			
				case 1:
					func_318(1697564429, iParam3);
					break;
			
				case 2:
					func_318(1674823841, iParam3);
					break;
			}
			break;
...
void func_330(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x27E04
{
	eCharacter character;
...
var func_331(Player plParam0) // Position - 0x27E9F
{
...
void func_371(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x297FD
{
	int i;
