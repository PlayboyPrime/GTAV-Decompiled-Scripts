...
BOOL func_86(int iParam0) // Position - 0xD4EB (54507)
{
	int num;
...
BOOL func_87(int iParam0) // Position - 0xD50F (54543)
{
	int num;
...
BOOL func_88(int iParam0, int iParam1) // Position - 0xD52D (54573)
{
