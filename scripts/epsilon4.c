...
ePedComponentType func_94(int iParam0) // Position - 0x9E3C
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_95(Hash hParam0, int iParam1) // Position - 0x9EEC
{
	int i;
	var unk;
...
struct<17> func_98(Hash hParam0, int iParam1) // Position - 0xA98D
{
	int i;
	var unk;
...
struct<14> func_102(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCB0F
{
	func_166();
...
BOOL func_167(Ped pedParam0, int iParam1, int iParam2) // Position - 0x201C4
{
	Hash entityModel;
	int num;
	int i;
...
void func_244() // Position - 0x27F4F
{
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		{
			obLocal_360 = VEHICLE::CREATE_VEHICLE(-16948145, 1851.57f, 4772.12f, 39.8f, 31.35f, true, true, false);
		...
		if (func_354(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_351 == 0)
			{
				...
				{
					obLocal_639 = func_276(PLAYER::PLAYER_PED_ID(), -38085395, 1, false, 0, 0, 0, 0, 0);
...
void func_257() // Position - 0x28B02
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			PED::FORCE_PED_MOTION_STATE(uLocal_604[1 /*8*/], -668482597, false, 1, false);
		}
	}
		...
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]) && func_294(obLocal_360))
				{
					...
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, obLocal_360, 1743.33f, 4962.18f, 45.16f, 20f, 0, -16948145, 786599, 5f, -1f);
			...
			PED::FORCE_PED_MOTION_STATE(uLocal_604[0 /*8*/], -668482597, false, 1, false);
		}
	}
...
void func_328(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DBEE
{
...
int func_345() // Position - 0x2EDEE
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(hLocal_158) || !STREAMING::HAS_MODEL_LOADED(-16948145))
		return 0;
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (func_283(1, 1093140480, 0))
		{
			...
			if (func_354(uLocal_81.f_28[1]))
			{
				...
				{
					obLocal_639 = func_276(uLocal_81.f_28[1], -38085395, 1, false, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(obLocal_639, "Artefact_Detector", 0, 0, 0);
				}
...
void func_349() // Position - 0x2F250
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			PED::FORCE_PED_MOTION_STATE(uLocal_604[0 /*8*/], -668482597, false, 1, true);
...
{
	func_405(1553931317, 1751.65f, 4676.77f, 43.03f, -2.33f, 0.99f, 91.36f);
	...
	func_405(-1966747703, 1756.68f, 4832.28f, 39.43f, 90f, 13.21f, 78.57f);
	...
	func_405(1803975195, 1847.863f, 4756.059f, 36.71f, -70.53f, 75.48f, 132.44f);
...
int func_415(var uParam0, eCharacter echParam1) // Position - 0x3172E
{
	int num;
