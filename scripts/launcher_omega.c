...
BOOL func_86(Player plParam0) // Position - 0x75C2
{
...
BOOL func_94(Player plParam0) // Position - 0x847A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD6C9
{
	...
	if (func_252(*panParam0) || func_250(*panParam0) || Global_79635 == 1)
		return true;
...
int func_261(var uParam0, eCharacter echParam1) // Position - 0xF4D4
{
	int num;
