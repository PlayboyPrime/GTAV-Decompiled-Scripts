...
BOOL func_86(Player plParam0) // Position - 0x771A
{
...
BOOL func_94(Player plParam0) // Position - 0x85D1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE39F
{
	...
	if (func_266(*panParam0) || func_264(*panParam0) || Global_79635 == 1)
		return true;
...
int func_277(var uParam0, eCharacter echParam1) // Position - 0x1047A
{
	int num;
