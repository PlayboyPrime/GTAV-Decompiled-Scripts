...
void func_47(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5A48 (23112)
{
	if (func_51())
	{
		if (iParam1 == 1)
		{
			...
			func_50(&(Global_2739811.f_4528), false, false);
			...
			if (bParam2)
			{
				...
				func_50(&(Global_2739811.f_4531), false, false);
			}
			else
			{
...
void func_50(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5C1A (23578)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
			*uParam0 = NETWORK::GET_NETWORK_TIME();
...
int func_80(BOOL bParam0) // Position - 0x6A60 (27232)
{
	int address;
	int i;
	Player playerIndex;
...
BOOL func_90(float fParam0, var uParam1, var uParam2) // Position - 0x6E7D (28285)
{
...
int func_202(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA662 (42594)
{
	int i;
