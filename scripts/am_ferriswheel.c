...
void main() // Position - 0x0
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	hLocal_285 = -1003748966;
	hLocal_286 = -1975182244;
...
void func_119() // Position - 0x835F
{
	...
	if (func_137(true) >= Global_262145.f_8418 || MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_8418, false, false, true, -1, 0))
	{
		...
		{
			_NETSHOPPING_PROCESS_TRANSACTION(1643659499, Global_262145.f_8418, &num, false, true, false);
	...
	switch (hParam0)
	{
		...
		case 571787049:
			if (iParam1 > 0 || Global_262145.f_27935)
				func_125(uParam2, -1135378931, 537254313, 1474183246, hParam0, iParam1, num, 7);
			break;
		...
		case 1138089938:
		case -561012053:
			func_125(uParam2, -1135378931, 1445302971, 1474183246, hParam0, iParam1, num, 7);
			break;
	}
