...
void func_4(Any* panParam0, int iParam1) // Position - 0xA70
{
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543.f_19), 8, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&panParam0->f_5543.f_19[0 /*7*/], 7, "TEMPSTAT_DATE");
	MISC::REGISTER_INT_TO_SAVE(&panParam0->f_5543.f_19[0 /*7*/], "TEMPSTAT_DATE.year");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5543.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	MISC::STOP_SAVE_STRUCT();
...
void func_5(Any* panParam0, int iParam1) // Position - 0xB3A
{
	...
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543.f_15), 4, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&panParam0->f_5543.f_15[0 /*3*/], 3, "TEMPSTAT_VEC");
	MISC::REGISTER_FLOAT_TO_SAVE(&panParam0->f_5543.f_15[0 /*3*/], "TEMPSTAT_VEC.x");
	MISC::REGISTER_FLOAT_TO_SAVE(&(panParam0->f_5543.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	MISC::REGISTER_FLOAT_TO_SAVE(&(panParam0->f_5543.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
	return;
}
...
void func_6(Any* panParam0, int iParam1) // Position - 0xBB3
{
	...
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543.f_6), 9, &arrayName);
	MISC::REGISTER_TEXT_LABEL_31_TO_SAVE(&panParam0->f_5543.f_6[0 /*8*/], "TEMPSTAT_LABEL");
	MISC::STOP_SAVE_ARRAY();
	return;
}
...
void func_7(Any* panParam0, int iParam1) // Position - 0xBEE
{
	...
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543.f_4), 2, &arrayName);
	MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_5543.f_4[0], "TEMPSTAT_BOOL");
	MISC::STOP_SAVE_ARRAY();
	return;
}
...
void func_8(Any* panParam0, int iParam1) // Position - 0xC28
{
	...
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543.f_2), 2, &arrayName);
	MISC::REGISTER_FLOAT_TO_SAVE(&panParam0->f_5543.f_2[0], "TEMPSTAT_FLOAT");
	MISC::STOP_SAVE_ARRAY();
	return;
}
...
void func_9(Any* panParam0, int iParam1) // Position - 0xC62
{
	...
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5543), 2, &arrayName);
	MISC::REGISTER_INT_TO_SAVE(&panParam0->f_5543[0], "TEMPSTAT_INT1");
	MISC::STOP_SAVE_ARRAY();
	return;
}
...
void func_10(Any* panParam0, int iParam1) // Position - 0xC98
{
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(panParam0->f_5393), 150, &structName);
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5393), "MPATM_CARET_");
	i = 0;
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGVAL", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5393.f_1), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name = { arrayName };
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_5393.f_1[i], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGSCRS", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5393.f_18), 97, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name2 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name2, i, 16);
		MISC::REGISTER_TEXT_LABEL_23_TO_SAVE(&panParam0->f_5393.f_18[i /*6*/], &name2);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGACT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5393.f_115), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name3 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name3, i, 16);
		MISC::REGISTER_ENUM_TO_SAVE(&panParam0->f_5393.f_115[i], &name3);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGDAT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5393.f_132), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name4 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name4, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_5393.f_132[i], &name4);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(panParam0->f_5393.f_149), "mpAnyVecBought");
	MISC::STOP_SAVE_STRUCT();
	return;
}
...
void func_11(Any* panParam0, int iParam1) // Position - 0xE12
{
	...
	TEXT_LABEL_APPEND_INT(&structName, iParam1, 24);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(panParam0->f_5152), 241, &structName);
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152), "BOUNTY_GAMERH64_1");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_1), "BOUNTY_GAMERH64_2");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_2), "BOUNTY_GAMERH64_3");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_3), "BOUNTY_GAMERH64_4");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_4), "BOUNTY_GAMERH64_5");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_5), "BOUNTY_GAMERH64_6");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_6), "BOUNTY_GAMERH64_7");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_7), "BOUNTY_GAMERH64_8");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_8), "BOUNTY_GAMERH64_9");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_9), "BOUNTY_GAMERH64_10");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_10), "BOUNTY_GAMERH64_11");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_11), "BOUNTY_GAMERH64_12");
	MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_12), "BOUNTY_GAMERH64_13");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5152.f_13), "BOUNTY_TIME");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_5152.f_14), "BOUNTY_VALUE");
	TEXT_LABEL_APPEND_STRING(&structName, "_GH", 24);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5152.f_15), 209, &structName);
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&panParam0->f_5152.f_15[i /*13*/], &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_2", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_1), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_3", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_2), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_4", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_3), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_5", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_4), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_6", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_5), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_7", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_6), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_8", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_7), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_9", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_8), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_10", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_9), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_11", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_10), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_12", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_11), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_13", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_5152.f_15[i /*13*/].f_12), &name);
	}
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_5152.f_224), 17, &structName);

	for (i = 0; i < 16; i = i + 1)
	{
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_5152.f_224[i], &name);
	}
...
void func_23() // Position - 0x2C1C
{
	...
	STATS::STAT_GET_INT(748568812, &outValue, -1);
	STATS::STAT_GET_INT(-444882618, &outValue2, -1);
	STATS::STAT_GET_INT(-1467624267, &outValue3, -1);
...
void func_29(int iParam0, int iParam1) // Position - 0x2E8A
{
	...
	unk5 = Global_113969.f_10197[iParam0 /*12*/].f_4;
	unk6 = Global_113969.f_10197[iParam0 /*12*/].f_5;
	unk7 = Global_113969.f_10197[iParam0 /*12*/].f_6;
	unk8 = Global_113969.f_10197[iParam0 /*12*/].f_7;
	unk9 = Global_113969.f_10197[iParam0 /*12*/].f_8;
	unk10 = Global_113969.f_10197[iParam0 /*12*/].f_9;
	unk11 = Global_113969.f_10197[iParam0 /*12*/].f_10;
	unk12 = Global_113969.f_10197[iParam0 /*12*/].f_11;
	...
	Global_113969.f_10197[iParam1 /*12*/].f_4 = unk5;
	Global_113969.f_10197[iParam1 /*12*/].f_5 = unk6;
	Global_113969.f_10197[iParam1 /*12*/].f_6 = unk7;
	Global_113969.f_10197[iParam1 /*12*/].f_7 = unk8;
	Global_113969.f_10197[iParam1 /*12*/].f_8 = unk9;
	Global_113969.f_10197[iParam1 /*12*/].f_9 = unk10;
	Global_113969.f_10197[iParam1 /*12*/].f_10 = unk11;
	Global_113969.f_10197[iParam1 /*12*/].f_11 = unk12;
	return;
}
...
void func_30() // Position - 0x308E
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (!func_31(Global_113969.f_24907[i /*4*/]))
			if (Global_113969.f_24907[i /*4*/] != 145)
				Global_113969.f_24907[i /*4*/] = 145;
	}
...
void func_82(int iParam0) // Position - 0x2314C
{
	...
	{
		case 0:
			SCRIPT::REQUEST_SCRIPT_WITH_NAME_HASH(2003913879);
			SCRIPT::REQUEST_SCRIPT_WITH_NAME_HASH(1790649497);
			break;
	}
