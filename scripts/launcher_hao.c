...
BOOL func_86(Player plParam0) // Position - 0x762D
{
...
BOOL func_94(Player plParam0) // Position - 0x84E4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD850
{
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_79635 == 1)
		return true;
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xF4B3
{
	int num;
...
BOOL func_257(int iParam0) // Position - 0xF52A
{
	int i;
