...
int func_118(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x9915 (39189)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_119(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x9AC2 (39618)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
int func_129(int iParam0) // Position - 0x9ED2 (40658)
{
	if (iParam0 == 1)
...
int func_219(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCE80 (52864)
{
	int i;
	int j;
	int k;
...
void func_222(Hash hParam0, int iParam1, int iParam2) // Position - 0xD76D (55149)
{
	int num;
	int num2;
...
BOOL func_223(Hash hParam0, int iParam1, int iParam2) // Position - 0xD7F7 (55287)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_224(Hash hParam0, int iParam1, int iParam2) // Position - 0xD8D5 (55509)
{
	Global_79527[1 /*14*/] = { func_267(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79527[1 /*14*/].f_6, 2);
}

BOOL func_225(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xD8FD (55549)
{
	var unk;
	int i;
...
BOOL func_226(Hash hParam0, int iParam1, int iParam2) // Position - 0xDF01 (57089)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_228(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE045 (57413)
{
	int i;
	int j;
...
int func_230(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE196 (57750)
{
	int num;
...
int func_231(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE49D (58525)
{
	int num;
	int num2;
	int num3;
...
BOOL func_232(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xF050 (61520)
{
	int num;
...
int func_233(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF334 (62260)
{
	int num;
...
int func_234(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF5FB (62971)
{
	int i;
	int num;
...
BOOL func_235(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF632 (63026)
{
	int num;
...
BOOL func_236(Hash hParam0, int iParam1, var uParam2) // Position - 0xF65B (63067)
{
	*uParam2 = -99;
...
int func_237(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF925 (63781)
{
	int num;
...
int func_238(Hash hParam0, int iParam1, int iParam2) // Position - 0xFBAF (64431)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_240(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xFDA0 (64928)
{
	switch (hParam0)
	{
...
Hash func_241(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFE6E (65134)
{
	var outProp;
	int componentId;
	int num;
...
int func_244(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x10390 (66448)
{
	Hash entityModel;
...
struct<10> func_249(Hash hParam0, int iParam1) // Position - 0x1076A (67434)
{
	int i;
	var unk;
...
struct<17> func_252(Hash hParam0, int iParam1) // Position - 0x1120B (70155)
{
	int i;
	var unk;
...
void func_255(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x132ED (78573)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
BOOL func_256(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1335E (78686)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_257(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x135DB (79323)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_258(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13A00 (80384)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_259(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13CF3 (81139)
{
	int pedPropIndex;
...
int func_260(Ped pedParam0, int iParam1) // Position - 0x13D3A (81210)
{
...
struct<14> func_267(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17B0C (97036)
{
	func_330();
...
int func_364(var uParam0, const char* sParam1, int iParam2) // Position - 0x2D01E (184350)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_365(const char* sParam0, int iParam1) // Position - 0x2D06A (184426)
{
...
BOOL func_377(int iParam0) // Position - 0x2D3EA (185322)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x2D40E (185358)
{
	int outValue;
